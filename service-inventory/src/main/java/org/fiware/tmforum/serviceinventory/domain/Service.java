...
public class Service extends EntityWithId {
    ...
    @Getter(onMethod = @__({@AttributeGetter(value = AttributeType.PROPERTY, targetName = "serviceSpecification")}))
    @Setter(onMethod = @__({@AttributeSetter(value = AttributeType.PROPERTY, targetName = "serviceSpecification", targetClass = ServiceSpecificationRef.class)}))
    ...
    @Getter(onMethod = @__({@AttributeGetter(value = AttributeType.RELATIONSHIP_LIST, targetName = "supportingResource", embedProperty = true)}))
    ...
    /*@Getter(onMethod = @__({@AttributeGetter(value = AttributeType.RELATIONSHIP, targetName = "supportingResource")}))
    @Setter(onMethod = @__({@AttributeSetter(value = AttributeType.RELATIONSHIP, targetName = "supportingResource", targetClass = ResourceRef.class)}))
    private ResourceRef supportingResource;

    @Getter(onMethod = @__({@AttributeGetter(value = AttributeType.PROPERTY, targetName = "supportingService")}))
    @Setter(onMethod = @__({@AttributeSetter(value = AttributeType.PROPERTY, targetName = "supportingService", targetClass = ServiceRefOrValue.class)}))
    private ServiceRefOrValue supportingService;*/
