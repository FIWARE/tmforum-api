...
import org.fiware.servicecatalog.model.CharacteristicValueSpecificationVOTestExample;
...
public class ServiceSpecificationApiIT extends AbstractApiIT implements ServiceSpecificationApiTestSpec {
    ...
    private static Stream<ArgumentPair<List<CharacteristicSpecificationVO>>> provideValidCharacteristicSpecLists() {
        ...
        validCharacteristicSpecs.add(
                new ArgumentPair<>("A single char without rels should be valid", List.of(
                        CharacteristicSpecificationVOTestExample.build().atSchemaLocation(null)
                                .id("urn:cs-1").charSpecRelationship(null)
                                .characteristicValueSpecification(null))));

        validCharacteristicSpecs.add(
                new ArgumentPair<>("A single char with a char value string is valid", List.of(
                        CharacteristicSpecificationVOTestExample.build()
                                .atSchemaLocation(null)
                                .id("urn:cs-1")
                                .charSpecRelationship(null)
                                .characteristicValueSpecification(
                                        List.of(
                                                CharacteristicValueSpecificationVOTestExample
                                                        .build()
                                                        .atSchemaLocation(null)
                                                        .value("abc def"))))));

        validCharacteristicSpecs.add(
                new ArgumentPair<>("A single char with a char value number is valid", List.of(
                        CharacteristicSpecificationVOTestExample.build()
                                .atSchemaLocation(null)
                                .id("urn:cs-1")
                                .charSpecRelationship(null)
                                .characteristicValueSpecification(
                                        List.of(CharacteristicValueSpecificationVOTestExample
                                                .build()
                                                .atSchemaLocation(null)
                                                .value(5))))));
    ...
    public void deleteServiceSpecification204() throws Exception {
        ...
        assertEquals(HttpStatus.NO_CONTENT,
                callAndCatch(() -> serviceSpecificationApiTestClient.deleteServiceSpecification(null, rfId)).getStatus(),
                "The service specification should have been deleted.");

        assertEquals(HttpStatus.NOT_FOUND,
                callAndCatch(() -> serviceSpecificationApiTestClient.retrieveServiceSpecification(null, rfId, null)).status(),
    ...
    public void deleteServiceSpecification404() throws Exception {
        HttpResponse<?> notFoundResponse = callAndCatch(
                () -> serviceSpecificationApiTestClient.deleteServiceSpecification(null,
        ...
        notFoundResponse = callAndCatch(
                () -> serviceSpecificationApiTestClient.deleteServiceSpecification(null, "invalid-id"));
        assertEquals(HttpStatus.NOT_FOUND,
                notFoundResponse.getStatus(),
                "No such resource-specification should exist.");
    ...
    public void listServiceSpecification200() throws Exception {
        ...
        HttpResponse<List<ServiceSpecificationVO>> serviceSpecificationResponse = callAndCatch(
                () -> serviceSpecificationApiTestClient.listServiceSpecification(null, null, null, null));
        ...
        HttpResponse<List<ServiceSpecificationVO>> firstPartResponse = callAndCatch(
                () -> serviceSpecificationApiTestClient.listServiceSpecification(null, null, 0, limit));
        assertEquals(limit, firstPartResponse.body().size(),
                "Only the requested number of entries should be returend.");
        HttpResponse<List<ServiceSpecificationVO>> secondPartResponse = callAndCatch(
                () -> serviceSpecificationApiTestClient.listServiceSpecification(null, null, 0 + limit, limit));
    ...
    public void listServiceSpecification400() throws Exception {
        HttpResponse<List<ServiceSpecificationVO>> badRequestResponse = callAndCatch(
                () -> serviceSpecificationApiTestClient.listServiceSpecification(null, null, -1, null));
        ...
        badRequestResponse = callAndCatch(
                () -> serviceSpecificationApiTestClient.listServiceSpecification(null, null, null, -1));
        assertEquals(HttpStatus.BAD_REQUEST,
                badRequestResponse.getStatus(),
    ...
    public void patchServiceSpecification200() throws Exception {
        ...
        HttpResponse<ServiceSpecificationVO> updateResponse = callAndCatch(
                () -> serviceSpecificationApiTestClient.patchServiceSpecification(null, resourceId,
                        serviceSpecificationUpdateVO));
        assertEquals(HttpStatus.OK, updateResponse.getStatus(), message);

        ServiceSpecificationVO updatedServiceSpecification = updateResponse.body();
        expectedServiceSpecification.href(URI.create(resourceId)).id(resourceId)
                .constraint(null)
    ...
    public void retrieveServiceSpecification200() throws Exception {
        ...
        HttpResponse<ServiceSpecificationVO> retrievedResourceSpec = callAndCatch(
                () -> serviceSpecificationApiTestClient.retrieveServiceSpecification(null, id, fieldsParameter));
    ...
    public void retrieveServiceSpecification404() throws Exception {
        HttpResponse<ServiceSpecificationVO> response = callAndCatch(
                () -> serviceSpecificationApiTestClient.retrieveServiceSpecification(null,
