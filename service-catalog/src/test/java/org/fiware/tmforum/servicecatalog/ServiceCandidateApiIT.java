...
public class ServiceCandidateApiIT extends AbstractApiIT implements ServiceCandidateApiTestSpec {
	...
	private static Stream<Arguments> provideValidServiceCandidates() {
		...
		ServiceCandidateCreateVO emptyCreate = ServiceCandidateCreateVOTestExample.build().atSchemaLocation(null).lifecycleStatus("created")
				.serviceSpecification(null);
		ServiceCandidateVO expectedEmpty = ServiceCandidateVOTestExample.build().atSchemaLocation(null).lifecycleStatus("created")
				.serviceSpecification(null);
		testEntries.add(
		...
		ServiceCandidateCreateVO createValidFor = ServiceCandidateCreateVOTestExample.build().atSchemaLocation(null).validFor(timePeriodVO)
				.lifecycleStatus("created").serviceSpecification(null);
		ServiceCandidateVO expectedValidFor = ServiceCandidateVOTestExample.build().atSchemaLocation(null).validFor(timePeriodVO)
				.lifecycleStatus("created").serviceSpecification(null);
	...
	private static Stream<Arguments> provideInvalidServiceCandidates() {
		...
		testEntries.add(Arguments.of("A service candidate with an spec ref should not be created.",
				ServiceCandidateCreateVOTestExample.build().atSchemaLocation(null)
		...
		testEntries.add(Arguments.of("A service candidate with non-existent category refs should not be created.",
				ServiceCandidateCreateVOTestExample.build().atSchemaLocation(null).category(List.of(ServiceCategoryRefVOTestExample.build().atSchemaLocation(null)
	...
	public void deleteServiceCandidate204() throws Exception {
		ServiceCandidateCreateVO emptyCreate = ServiceCandidateCreateVOTestExample.build().atSchemaLocation(null).serviceSpecification(null);
	...
	public void listServiceCandidate200() throws Exception {
		...
		for (int i = 0; i < 10; i++) {
			ServiceCandidateCreateVO serviceCandidateCreateVO = ServiceCandidateCreateVOTestExample.build().atSchemaLocation(null)
					.serviceSpecification(null);
	...
	public void patchServiceCandidate200() throws Exception {
		...
		expectedServiceCandidate.href(URI.create(resourceId)).id(resourceId);
	...
	private static Stream<Arguments> provideServiceCandidateUpdates() {
		...
		TimePeriodVO timePeriodVO = TimePeriodVOTestExample.build().endDateTime(Instant.now())
				.startDateTime(Instant.now());
		ServiceCandidateUpdateVO validForUpdate = ServiceCandidateUpdateVOTestExample.build().atSchemaLocation(null).validFor(timePeriodVO)
				.serviceSpecification(null);
		ServiceCandidateVO expectedValidForUpdate = ServiceCandidateVOTestExample.build().atSchemaLocation(null).validFor(timePeriodVO)
				.serviceSpecification(null);
	...
	private static Stream<Arguments> provideInvalidUpdates() {
		...
		testEntries.add(Arguments.of("An update with an invalid resource spe ref is not allowed.",
				ServiceCandidateUpdateVOTestExample.build().atSchemaLocation(null)
						.serviceSpecification(ServiceSpecificationRefVOTestExample.build().atSchemaLocation(null))));
