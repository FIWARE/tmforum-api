...
public class ServiceCandidateRefVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCandidateRefVO other = (ServiceCandidateRefVO) object;
	...
	public ServiceCandidateRefVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public ServiceCandidateRefVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public ServiceCandidateRefVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ServiceCandidateRefVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ServiceCandidateRefVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ServiceCandidateRefVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ServiceCandidateRefVO atType(java.lang.String newAtType) {
		this.atType = newAtType;
		return this;
	}

	public ServiceCandidateRefVO atReferredType(java.lang.String newAtReferredType) {
