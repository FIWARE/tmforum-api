...
public class ServiceCatalogBatchEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCatalogBatchEventVO other = (ServiceCatalogBatchEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCatalogBatchEventVO[")
	...
	public ServiceCatalogBatchEventVO event(ServiceCatalogBatchEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceCatalogBatchEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceCatalogBatchEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceCatalogBatchEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceCatalogBatchEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceCatalogBatchEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceCatalogBatchEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceCatalogBatchEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCatalogBatchEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceCatalogBatchEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceCatalogBatchEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceCatalogBatchEventPayloadVO newEvent) {
		this.event = newEvent;
	}
