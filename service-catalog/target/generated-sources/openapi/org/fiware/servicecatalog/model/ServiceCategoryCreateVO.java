...
public class ServiceCategoryCreateVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCategoryCreateVO other = (ServiceCategoryCreateVO) object;
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(description, isRoot, lastUpdate, lifecycleStatus, name, parentId, version, category, serviceCandidate, validFor, atBaseType, atSchemaLocation, atType);
	}

	@Override
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCategoryCreateVO[")
	...
	public ServiceCategoryCreateVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCategoryCreateVO isRoot(java.lang.Boolean newIsRoot) {
		this.isRoot = newIsRoot;
		return this;
	}

	public ServiceCategoryCreateVO lastUpdate(java.time.Instant newLastUpdate) {
		this.lastUpdate = newLastUpdate;
		return this;
	}

	public ServiceCategoryCreateVO lifecycleStatus(java.lang.String newLifecycleStatus) {
		this.lifecycleStatus = newLifecycleStatus;
		return this;
	}

	public ServiceCategoryCreateVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ServiceCategoryCreateVO parentId(java.lang.String newParentId) {
		this.parentId = newParentId;
		return this;
	}

	public ServiceCategoryCreateVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ServiceCategoryCreateVO category(java.util.List<ServiceCategoryRefVO> newCategory) {
	...
	public ServiceCategoryCreateVO serviceCandidate(java.util.List<ServiceCandidateRefVO> newServiceCandidate) {
	...
	public ServiceCategoryCreateVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ServiceCategoryCreateVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ServiceCategoryCreateVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ServiceCategoryCreateVO atType(java.lang.String newAtType) {
