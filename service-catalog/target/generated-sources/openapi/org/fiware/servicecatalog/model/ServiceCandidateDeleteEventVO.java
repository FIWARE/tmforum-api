...
public class ServiceCandidateDeleteEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCandidateDeleteEventVO other = (ServiceCandidateDeleteEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCandidateDeleteEventVO[")
	...
	public ServiceCandidateDeleteEventVO event(ServiceCandidateDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceCandidateDeleteEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceCandidateDeleteEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceCandidateDeleteEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceCandidateDeleteEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceCandidateDeleteEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceCandidateDeleteEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceCandidateDeleteEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCandidateDeleteEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceCandidateDeleteEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceCandidateDeleteEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceCandidateDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
	}
