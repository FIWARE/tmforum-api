...
public class ServiceSpecificationCreateEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceSpecificationCreateEventVO other = (ServiceSpecificationCreateEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceSpecificationCreateEventVO[")
	...
	public ServiceSpecificationCreateEventVO event(ServiceSpecificationCreateEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceSpecificationCreateEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceSpecificationCreateEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceSpecificationCreateEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceSpecificationCreateEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceSpecificationCreateEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceSpecificationCreateEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceSpecificationCreateEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceSpecificationCreateEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceSpecificationCreateEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceSpecificationCreateEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceSpecificationCreateEventPayloadVO newEvent) {
		this.event = newEvent;
	}
