...
public class ServiceCandidateChangeEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCandidateChangeEventVO other = (ServiceCandidateChangeEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCandidateChangeEventVO[")
	...
	public ServiceCandidateChangeEventVO event(ServiceCandidateChangeEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceCandidateChangeEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceCandidateChangeEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceCandidateChangeEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceCandidateChangeEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceCandidateChangeEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceCandidateChangeEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceCandidateChangeEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCandidateChangeEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceCandidateChangeEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceCandidateChangeEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceCandidateChangeEventPayloadVO newEvent) {
		this.event = newEvent;
	}
