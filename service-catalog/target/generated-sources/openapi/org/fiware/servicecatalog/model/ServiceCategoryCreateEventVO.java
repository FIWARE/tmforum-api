...
public class ServiceCategoryCreateEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCategoryCreateEventVO other = (ServiceCategoryCreateEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCategoryCreateEventVO[")
	...
	public ServiceCategoryCreateEventVO event(ServiceCategoryCreateEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceCategoryCreateEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceCategoryCreateEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceCategoryCreateEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceCategoryCreateEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceCategoryCreateEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceCategoryCreateEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceCategoryCreateEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCategoryCreateEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceCategoryCreateEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceCategoryCreateEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceCategoryCreateEventPayloadVO newEvent) {
		this.event = newEvent;
	}
