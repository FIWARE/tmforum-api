...
public class ServiceCategoryDeleteEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCategoryDeleteEventVO other = (ServiceCategoryDeleteEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCategoryDeleteEventVO[")
	...
	public ServiceCategoryDeleteEventVO event(ServiceCategoryDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceCategoryDeleteEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceCategoryDeleteEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceCategoryDeleteEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceCategoryDeleteEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceCategoryDeleteEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceCategoryDeleteEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceCategoryDeleteEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCategoryDeleteEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceCategoryDeleteEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceCategoryDeleteEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceCategoryDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
	}
