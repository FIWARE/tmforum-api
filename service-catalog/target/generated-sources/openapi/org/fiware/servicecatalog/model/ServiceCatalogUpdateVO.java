...
public class ServiceCatalogUpdateVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCatalogUpdateVO other = (ServiceCatalogUpdateVO) object;
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(description, lifecycleStatus, name, version, category, relatedParty, validFor, atBaseType, atSchemaLocation, atType);
	}

	@Override
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCatalogUpdateVO[")
	...
	public ServiceCatalogUpdateVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCatalogUpdateVO lifecycleStatus(java.lang.String newLifecycleStatus) {
		this.lifecycleStatus = newLifecycleStatus;
		return this;
	}

	public ServiceCatalogUpdateVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ServiceCatalogUpdateVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ServiceCatalogUpdateVO category(java.util.List<ServiceCategoryRefVO> newCategory) {
	...
	public ServiceCatalogUpdateVO relatedParty(java.util.List<RelatedPartyVO> newRelatedParty) {
	...
	public ServiceCatalogUpdateVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ServiceCatalogUpdateVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ServiceCatalogUpdateVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ServiceCatalogUpdateVO atType(java.lang.String newAtType) {
