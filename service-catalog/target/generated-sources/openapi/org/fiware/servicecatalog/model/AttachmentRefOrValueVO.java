...
public class AttachmentRefOrValueVO {
	...
	public boolean equals(Object object) {
		...
		AttachmentRefOrValueVO other = (AttachmentRefOrValueVO) object;
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(id, href, attachmentType, content, description, mimeType, name, url, size, validFor, atBaseType, atSchemaLocation, atType, atReferredType);
	}

	@Override
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("AttachmentRefOrValueVO[")
	...
	public AttachmentRefOrValueVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public AttachmentRefOrValueVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public AttachmentRefOrValueVO attachmentType(java.lang.String newAttachmentType) {
		this.attachmentType = newAttachmentType;
		return this;
	}

	public AttachmentRefOrValueVO content(java.lang.String newContent) {
		this.content = newContent;
		return this;
	}

	public AttachmentRefOrValueVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public AttachmentRefOrValueVO mimeType(java.lang.String newMimeType) {
		this.mimeType = newMimeType;
		return this;
	}

	public AttachmentRefOrValueVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public AttachmentRefOrValueVO url(java.net.URI newUrl) {
		this.url = newUrl;
		return this;
	}

	public AttachmentRefOrValueVO size(QuantityVO newSize) {
		this.size = newSize;
		return this;
	}

	public AttachmentRefOrValueVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public AttachmentRefOrValueVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public AttachmentRefOrValueVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public AttachmentRefOrValueVO atType(java.lang.String newAtType) {
		this.atType = newAtType;
		return this;
	}

	public AttachmentRefOrValueVO atReferredType(java.lang.String newAtReferredType) {
