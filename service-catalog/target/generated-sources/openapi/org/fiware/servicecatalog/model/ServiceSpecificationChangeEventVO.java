...
public class ServiceSpecificationChangeEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceSpecificationChangeEventVO other = (ServiceSpecificationChangeEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceSpecificationChangeEventVO[")
	...
	public ServiceSpecificationChangeEventVO event(ServiceSpecificationChangeEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceSpecificationChangeEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceSpecificationChangeEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceSpecificationChangeEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceSpecificationChangeEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceSpecificationChangeEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceSpecificationChangeEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceSpecificationChangeEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceSpecificationChangeEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceSpecificationChangeEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceSpecificationChangeEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceSpecificationChangeEventPayloadVO newEvent) {
		this.event = newEvent;
	}
