...
public class ServiceSpecificationDeleteEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceSpecificationDeleteEventVO other = (ServiceSpecificationDeleteEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceSpecificationDeleteEventVO[")
	...
	public ServiceSpecificationDeleteEventVO event(ServiceSpecificationDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceSpecificationDeleteEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceSpecificationDeleteEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceSpecificationDeleteEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceSpecificationDeleteEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceSpecificationDeleteEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceSpecificationDeleteEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceSpecificationDeleteEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceSpecificationDeleteEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceSpecificationDeleteEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceSpecificationDeleteEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceSpecificationDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
	}
