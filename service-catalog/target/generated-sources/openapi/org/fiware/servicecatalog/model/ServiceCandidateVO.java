...
public class ServiceCandidateVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCandidateVO other = (ServiceCandidateVO) object;
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(id, href, description, lastUpdate, lifecycleStatus, name, version, category, serviceSpecification, validFor, atBaseType, atSchemaLocation, atType);
	}

	@Override
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCandidateVO[")
	...
	public ServiceCandidateVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public ServiceCandidateVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public ServiceCandidateVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCandidateVO lastUpdate(java.time.Instant newLastUpdate) {
		this.lastUpdate = newLastUpdate;
		return this;
	}

	public ServiceCandidateVO lifecycleStatus(java.lang.String newLifecycleStatus) {
		this.lifecycleStatus = newLifecycleStatus;
		return this;
	}

	public ServiceCandidateVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ServiceCandidateVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ServiceCandidateVO category(java.util.List<ServiceCategoryRefVO> newCategory) {
	...
	public ServiceCandidateVO serviceSpecification(ServiceSpecificationRefVO newServiceSpecification) {
		this.serviceSpecification = newServiceSpecification;
		return this;
	}

	public ServiceCandidateVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ServiceCandidateVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ServiceCandidateVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ServiceCandidateVO atType(java.lang.String newAtType) {
