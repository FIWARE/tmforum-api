...
public class ServiceCategoryRefVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCategoryRefVO other = (ServiceCategoryRefVO) object;
	...
	public ServiceCategoryRefVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public ServiceCategoryRefVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public ServiceCategoryRefVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ServiceCategoryRefVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ServiceCategoryRefVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ServiceCategoryRefVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ServiceCategoryRefVO atType(java.lang.String newAtType) {
		this.atType = newAtType;
		return this;
	}

	public ServiceCategoryRefVO atReferredType(java.lang.String newAtReferredType) {
