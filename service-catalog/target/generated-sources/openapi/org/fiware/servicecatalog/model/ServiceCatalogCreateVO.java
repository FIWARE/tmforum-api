...
public class ServiceCatalogCreateVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCatalogCreateVO other = (ServiceCatalogCreateVO) object;
	...
	public ServiceCatalogCreateVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCatalogCreateVO lastUpdate(java.time.Instant newLastUpdate) {
		this.lastUpdate = newLastUpdate;
		return this;
	}

	public ServiceCatalogCreateVO lifecycleStatus(java.lang.String newLifecycleStatus) {
		this.lifecycleStatus = newLifecycleStatus;
		return this;
	}

	public ServiceCatalogCreateVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ServiceCatalogCreateVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ServiceCatalogCreateVO category(java.util.List<ServiceCategoryRefVO> newCategory) {
	...
	public ServiceCatalogCreateVO relatedParty(java.util.List<RelatedPartyVO> newRelatedParty) {
	...
	public ServiceCatalogCreateVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ServiceCatalogCreateVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ServiceCatalogCreateVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ServiceCatalogCreateVO atType(java.lang.String newAtType) {
