...
public class ServiceCatalogCreateEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCatalogCreateEventVO other = (ServiceCatalogCreateEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCatalogCreateEventVO[")
	...
	public ServiceCatalogCreateEventVO event(ServiceCatalogCreateEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceCatalogCreateEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceCatalogCreateEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceCatalogCreateEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceCatalogCreateEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceCatalogCreateEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceCatalogCreateEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceCatalogCreateEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCatalogCreateEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceCatalogCreateEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceCatalogCreateEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceCatalogCreateEventPayloadVO newEvent) {
		this.event = newEvent;
	}
