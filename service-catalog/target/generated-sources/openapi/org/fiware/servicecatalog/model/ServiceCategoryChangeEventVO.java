...
public class ServiceCategoryChangeEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCategoryChangeEventVO other = (ServiceCategoryChangeEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCategoryChangeEventVO[")
	...
	public ServiceCategoryChangeEventVO event(ServiceCategoryChangeEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceCategoryChangeEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceCategoryChangeEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceCategoryChangeEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceCategoryChangeEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceCategoryChangeEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceCategoryChangeEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceCategoryChangeEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCategoryChangeEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceCategoryChangeEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceCategoryChangeEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceCategoryChangeEventPayloadVO newEvent) {
		this.event = newEvent;
	}
