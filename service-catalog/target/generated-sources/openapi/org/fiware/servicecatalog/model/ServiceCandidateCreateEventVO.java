...
public class ServiceCandidateCreateEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCandidateCreateEventVO other = (ServiceCandidateCreateEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCandidateCreateEventVO[")
	...
	public ServiceCandidateCreateEventVO event(ServiceCandidateCreateEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceCandidateCreateEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceCandidateCreateEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceCandidateCreateEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceCandidateCreateEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceCandidateCreateEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceCandidateCreateEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceCandidateCreateEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCandidateCreateEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceCandidateCreateEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceCandidateCreateEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceCandidateCreateEventPayloadVO newEvent) {
		this.event = newEvent;
	}
