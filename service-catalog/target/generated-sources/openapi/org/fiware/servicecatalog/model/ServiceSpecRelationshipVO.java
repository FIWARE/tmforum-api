...
public class ServiceSpecRelationshipVO {
	...
	public boolean equals(Object object) {
		...
		ServiceSpecRelationshipVO other = (ServiceSpecRelationshipVO) object;
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(id, href, name, relationshipType, role, validFor, atBaseType, atSchemaLocation, atType, atReferredType);
	}

	@Override
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceSpecRelationshipVO[")
	...
	public ServiceSpecRelationshipVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public ServiceSpecRelationshipVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public ServiceSpecRelationshipVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ServiceSpecRelationshipVO relationshipType(java.lang.String newRelationshipType) {
		this.relationshipType = newRelationshipType;
		return this;
	}

	public ServiceSpecRelationshipVO role(java.lang.String newRole) {
		this.role = newRole;
		return this;
	}

	public ServiceSpecRelationshipVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ServiceSpecRelationshipVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ServiceSpecRelationshipVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ServiceSpecRelationshipVO atType(java.lang.String newAtType) {
		this.atType = newAtType;
		return this;
	}

	public ServiceSpecRelationshipVO atReferredType(java.lang.String newAtReferredType) {
