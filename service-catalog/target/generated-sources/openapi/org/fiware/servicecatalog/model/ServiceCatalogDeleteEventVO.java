...
public class ServiceCatalogDeleteEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCatalogDeleteEventVO other = (ServiceCatalogDeleteEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCatalogDeleteEventVO[")
	...
	public ServiceCatalogDeleteEventVO event(ServiceCatalogDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceCatalogDeleteEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceCatalogDeleteEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceCatalogDeleteEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceCatalogDeleteEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceCatalogDeleteEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceCatalogDeleteEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceCatalogDeleteEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCatalogDeleteEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceCatalogDeleteEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceCatalogDeleteEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceCatalogDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
	}
