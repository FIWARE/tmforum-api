...
public class ServiceCatalogChangeEventVO {
	...
	public boolean equals(Object object) {
		...
		ServiceCatalogChangeEventVO other = (ServiceCatalogChangeEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ServiceCatalogChangeEventVO[")
	...
	public ServiceCatalogChangeEventVO event(ServiceCatalogChangeEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ServiceCatalogChangeEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ServiceCatalogChangeEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ServiceCatalogChangeEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ServiceCatalogChangeEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ServiceCatalogChangeEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ServiceCatalogChangeEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ServiceCatalogChangeEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ServiceCatalogChangeEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ServiceCatalogChangeEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ServiceCatalogChangeEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ServiceCatalogChangeEventPayloadVO newEvent) {
		this.event = newEvent;
	}
