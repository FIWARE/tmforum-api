...
public class ServiceSpecificationVOTestExample {

	public static ServiceSpecificationVO build() {
		ServiceSpecificationVO exampleInstance = new ServiceSpecificationVO();
		//initialize fields
