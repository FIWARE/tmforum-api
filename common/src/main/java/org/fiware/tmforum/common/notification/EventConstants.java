...
public class EventConstants {
	public static final String NOTIFICATION_FORMAT = "normalized";
	public static final String NOTIFICATION_PAYLOAD_MIME_TYPE = "application/json";
	public static final String SUBSCRIPTION_CALLBACK_PATH = "/callback";

	public static final String EVENT_GROUP_PRODUCT = "Product";
	public static final String EVENT_GROUP_CATALOG = "Catalog";
	public static final String EVENT_GROUP_QUOTE = "Quote";
	public static final String EVENT_GROUP_CATEGORY = "Category";
	public static final String EVENT_GROUP_PRODUCT_OFFERING = "ProductOffering";
	public static final String EVENT_GROUP_PRODUCT_OFFERING_PRICE = "ProductOfferingPrice";
	public static final String EVENT_GROUP_PRODUCT_SPECIFICATION = "ProductSpecification";
	public static final String EVENT_GROUP_SERVICE_CANDIDATE = "ServiceCandidate";
	public static final String EVENT_GROUP_SERVICE_CATALOG = "ServiceCatalog";
	public static final String EVENT_GROUP_SERVICE_CATEGORY = "ServiceCategory";
	public static final String EVENT_GROUP_SERVICE_SPECIFICATION = "ServiceSpecification";
	public static final String EVENT_GROUP_RESOURCE = "Resource";
	public static final String EVENT_GROUP_HEAL = "Heal";
	public static final String EVENT_GROUP_MIGRATE = "Migrate";
	public static final String EVENT_GROUP_MONITOR = "Monitor";
	public static final String EVENT_GROUP_RESOURCE_FUNCTION = "ResourceFunction";
	public static final String EVENT_GROUP_SCALE = "Scale";
	public static final String EVENT_GROUP_RESOURCE_CANDIDATE = "ResourceCandidate";
	public static final String EVENT_GROUP_RESOURCE_CATALOG = "ResourceCatalog";
	public static final String EVENT_GROUP_RESOURCE_CATEGORY = "ResourceCategory";
	public static final String EVENT_GROUP_RESOURCE_SPECIFICATION = "ResourceSpecification";
	public static final String EVENT_GROUP_CANCEL_PRODUCT_ORDER = "CancelProductOrder";
	public static final String EVENT_GROUP_PRODUCT_ORDER = "ProductOrder";
	public static final String EVENT_GROUP_INDIVIDUAL = "Individual";
	public static final String EVENT_GROUP_ORGANIZATION = "Organization";
	public static final String EVENT_GROUP_CUSTOMER = "Customer";
	public static final String EVENT_GROUP_AGREEMENT = "Agreement";
	public static final String EVENT_GROUP_AGREEMENT_SPECIFICATION = "AgreementSpecification";
	public static final String EVENT_GROUP_BILL_FORMAT = "BillFormat";
	public static final String EVENT_GROUP_BILLING_ACCOUNT = "BillingAccount";
	public static final String EVENT_GROUP_BILLING_CYCLE_SPECIFICATION = "BillingCycleSpecification";
	public static final String EVENT_GROUP_BILL_PRESENTATION_MEDIA = "BillPresentationMedia";
	public static final String EVENT_GROUP_FINANCIAL_ACCOUNT = "FinancialAccount";
	public static final String EVENT_GROUP_PARTY_ACCOUNT = "PartyAccount";
	public static final String EVENT_GROUP_SETTLEMENT_ACCOUNT = "SettlementAccount";
	...
	public static final String EVENT_GROUP_RESOURCE_ORDER = "ResourceOrder";
	public static final String EVENT_GROUP_CANCEL_RESOURCE_ORDER = "CancelResourceOrder";
	public static final String EVENT_GROUP_SERVICE_ORDER = "ServiceOrder";
	public static final String EVENT_GROUP_CANCEL_SERVICE_ORDER = "CancelServiceOrder";
	...
	public static final Map<String, List<String>> ALLOWED_EVENT_TYPES = Map.ofEntries(
			...
			entry(EVENT_GROUP_CUSTOMER_BILL_ON_DEMAND, List.of(CREATE_EVENT_SUFFIX, ATTRIBUTE_VALUE_CHANGE_EVENT_SUFFIX,
					STATE_CHANGE_EVENT_SUFFIX, DELETE_EVENT_SUFFIX)),
			entry(EVENT_GROUP_RESOURCE_ORDER, List.of(CREATE_EVENT_SUFFIX, ATTRIBUTE_VALUE_CHANGE_EVENT_SUFFIX,
					STATE_CHANGE_EVENT_SUFFIX, DELETE_EVENT_SUFFIX, INFORMATION_REQUIRED_EVENT_SUFFIX)),
			entry(EVENT_GROUP_CANCEL_RESOURCE_ORDER, List.of(CREATE_EVENT_SUFFIX, INFORMATION_REQUIRED_EVENT_SUFFIX,
					STATE_CHANGE_EVENT_SUFFIX)),
			entry(EVENT_GROUP_SERVICE_ORDER, List.of(CREATE_EVENT_SUFFIX, ATTRIBUTE_VALUE_CHANGE_EVENT_SUFFIX,
					STATE_CHANGE_EVENT_SUFFIX, DELETE_EVENT_SUFFIX, INFORMATION_REQUIRED_EVENT_SUFFIX)),
			entry(EVENT_GROUP_CANCEL_SERVICE_ORDER, List.of(CREATE_EVENT_SUFFIX, INFORMATION_REQUIRED_EVENT_SUFFIX,
					STATE_CHANGE_EVENT_SUFFIX))
	);
}
