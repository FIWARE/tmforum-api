...
public class ResourceSpecificationCreateVOTestExample {

	public static ResourceSpecificationCreateVO build() {
		ResourceSpecificationCreateVO exampleInstance = new ResourceSpecificationCreateVO();
		//initialize fields
