...
public class ResourceCandidateUpdateVOTestExample {

	public static ResourceCandidateUpdateVO build() {
		ResourceCandidateUpdateVO exampleInstance = new ResourceCandidateUpdateVO();
		//initialize fields
