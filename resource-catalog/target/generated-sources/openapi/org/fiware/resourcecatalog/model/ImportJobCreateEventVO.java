...
public class ImportJobCreateEventVO {
	...
	private ImportJobCreateEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ImportJobCreateEventVO other = (ImportJobCreateEventVO) object;
	...
	public ImportJobCreateEventVO event(ImportJobCreateEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ImportJobCreateEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ImportJobCreateEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ImportJobCreateEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ImportJobCreateEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ImportJobCreateEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ImportJobCreateEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ImportJobCreateEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ImportJobCreateEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ImportJobCreateEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ImportJobCreateEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ImportJobCreateEventPayloadVO newEvent) {
		this.event = newEvent;
	}
