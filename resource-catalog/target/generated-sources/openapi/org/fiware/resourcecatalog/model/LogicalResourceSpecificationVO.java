...
public class LogicalResourceSpecificationVO {
	...
	public boolean equals(Object object) {
		...
		LogicalResourceSpecificationVO other = (LogicalResourceSpecificationVO) object;
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(id, href, category, description, isBundle, lastUpdate, lifecycleStatus, name, version, attachment, featureSpecification, relatedParty, resourceSpecCharacteristic, resourceSpecRelationship, targetResourceSchema, validFor, atBaseType, atSchemaLocation, atType);
	}

	@Override
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("LogicalResourceSpecificationVO[")
	...
	public LogicalResourceSpecificationVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public LogicalResourceSpecificationVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public LogicalResourceSpecificationVO category(java.lang.String newCategory) {
		this.category = newCategory;
		return this;
	}

	public LogicalResourceSpecificationVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public LogicalResourceSpecificationVO isBundle(java.lang.Boolean newIsBundle) {
		this.isBundle = newIsBundle;
		return this;
	}

	public LogicalResourceSpecificationVO lastUpdate(java.time.Instant newLastUpdate) {
		this.lastUpdate = newLastUpdate;
		return this;
	}

	public LogicalResourceSpecificationVO lifecycleStatus(java.lang.String newLifecycleStatus) {
		this.lifecycleStatus = newLifecycleStatus;
		return this;
	}

	public LogicalResourceSpecificationVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public LogicalResourceSpecificationVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public LogicalResourceSpecificationVO attachment(java.util.List<AttachmentRefOrValueVO> newAttachment) {
		this.attachment = newAttachment;
		return this;
	}
	
	public LogicalResourceSpecificationVO addAttachmentItem(AttachmentRefOrValueVO attachmentItem) {
	...
	public LogicalResourceSpecificationVO removeAttachmentItem(AttachmentRefOrValueVO attachmentItem) {
		if (this.attachment != null) {
	...
	public LogicalResourceSpecificationVO featureSpecification(java.util.List<FeatureSpecificationVO> newFeatureSpecification) {
		this.featureSpecification = newFeatureSpecification;
		return this;
	}
	
	public LogicalResourceSpecificationVO addFeatureSpecificationItem(FeatureSpecificationVO featureSpecificationItem) {
	...
	public LogicalResourceSpecificationVO removeFeatureSpecificationItem(FeatureSpecificationVO featureSpecificationItem) {
		if (this.featureSpecification != null) {
	...
	public LogicalResourceSpecificationVO relatedParty(java.util.List<RelatedPartyVO> newRelatedParty) {
		this.relatedParty = newRelatedParty;
		return this;
	}
	
	public LogicalResourceSpecificationVO addRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
	...
	public LogicalResourceSpecificationVO removeRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
		if (this.relatedParty != null) {
	...
	public LogicalResourceSpecificationVO resourceSpecCharacteristic(java.util.List<ResourceSpecificationCharacteristicVO> newResourceSpecCharacteristic) {
		this.resourceSpecCharacteristic = newResourceSpecCharacteristic;
		return this;
	}
	
	public LogicalResourceSpecificationVO addResourceSpecCharacteristicItem(ResourceSpecificationCharacteristicVO resourceSpecCharacteristicItem) {
	...
	public LogicalResourceSpecificationVO removeResourceSpecCharacteristicItem(ResourceSpecificationCharacteristicVO resourceSpecCharacteristicItem) {
		if (this.resourceSpecCharacteristic != null) {
	...
	public LogicalResourceSpecificationVO resourceSpecRelationship(java.util.List<ResourceSpecificationRelationshipVO> newResourceSpecRelationship) {
		this.resourceSpecRelationship = newResourceSpecRelationship;
		return this;
	}
	
	public LogicalResourceSpecificationVO addResourceSpecRelationshipItem(ResourceSpecificationRelationshipVO resourceSpecRelationshipItem) {
	...
	public LogicalResourceSpecificationVO removeResourceSpecRelationshipItem(ResourceSpecificationRelationshipVO resourceSpecRelationshipItem) {
		if (this.resourceSpecRelationship != null) {
	...
	public LogicalResourceSpecificationVO targetResourceSchema(TargetResourceSchemaVO newTargetResourceSchema) {
		this.targetResourceSchema = newTargetResourceSchema;
		return this;
	}

	public LogicalResourceSpecificationVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public LogicalResourceSpecificationVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public LogicalResourceSpecificationVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public LogicalResourceSpecificationVO atType(java.lang.String newAtType) {
