...
public class ResourceSpecificationCreateEventVO {
	...
	private ResourceSpecificationCreateEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ResourceSpecificationCreateEventVO other = (ResourceSpecificationCreateEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceSpecificationCreateEventVO[")
	...
	public ResourceSpecificationCreateEventVO event(ResourceSpecificationCreateEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ResourceSpecificationCreateEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ResourceSpecificationCreateEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ResourceSpecificationCreateEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ResourceSpecificationCreateEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ResourceSpecificationCreateEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ResourceSpecificationCreateEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ResourceSpecificationCreateEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceSpecificationCreateEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ResourceSpecificationCreateEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ResourceSpecificationCreateEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ResourceSpecificationCreateEventPayloadVO newEvent) {
		this.event = newEvent;
	}
