...
public class RelatedPartyVO {
	...
	public boolean equals(Object object) {
		...
		RelatedPartyVO other = (RelatedPartyVO) object;
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(id, href, name, role, atBaseType, atSchemaLocation, atType, atReferredType);
	}

	@Override
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("RelatedPartyVO[")
	...
	public RelatedPartyVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public RelatedPartyVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public RelatedPartyVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public RelatedPartyVO role(java.lang.String newRole) {
		this.role = newRole;
		return this;
	}

	public RelatedPartyVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public RelatedPartyVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public RelatedPartyVO atType(java.lang.String newAtType) {
		this.atType = newAtType;
		return this;
	}

	public RelatedPartyVO atReferredType(java.lang.String newAtReferredType) {
