...
public class EntityVO {
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(id, href, atBaseType, atSchemaLocation, atType);
	}
	...
	public EntityVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public EntityVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public EntityVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public EntityVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public EntityVO atType(java.lang.String newAtType) {
