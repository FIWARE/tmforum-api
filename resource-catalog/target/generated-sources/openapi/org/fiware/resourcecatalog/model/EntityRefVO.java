...
public class EntityRefVO {
	...
	public boolean equals(Object object) {
		...
		EntityRefVO other = (EntityRefVO) object;
	...
	public EntityRefVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public EntityRefVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public EntityRefVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public EntityRefVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public EntityRefVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public EntityRefVO atType(java.lang.String newAtType) {
		this.atType = newAtType;
		return this;
	}

	public EntityRefVO atReferredType(java.lang.String newAtReferredType) {
