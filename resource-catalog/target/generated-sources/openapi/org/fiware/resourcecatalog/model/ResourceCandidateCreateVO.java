...
public class ResourceCandidateCreateVO {
	...
	public boolean equals(Object object) {
		...
		ResourceCandidateCreateVO other = (ResourceCandidateCreateVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCandidateCreateVO[")
	...
	public ResourceCandidateCreateVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCandidateCreateVO lastUpdate(java.time.Instant newLastUpdate) {
		this.lastUpdate = newLastUpdate;
		return this;
	}

	public ResourceCandidateCreateVO lifecycleStatus(java.lang.String newLifecycleStatus) {
		this.lifecycleStatus = newLifecycleStatus;
		return this;
	}

	public ResourceCandidateCreateVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ResourceCandidateCreateVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ResourceCandidateCreateVO category(java.util.List<ResourceCategoryRefVO> newCategory) {
		this.category = newCategory;
		return this;
	}
	
	public ResourceCandidateCreateVO addCategoryItem(ResourceCategoryRefVO categoryItem) {
	...
	public ResourceCandidateCreateVO removeCategoryItem(ResourceCategoryRefVO categoryItem) {
		if (this.category != null) {
	...
	public ResourceCandidateCreateVO resourceSpecification(ResourceSpecificationRefVO newResourceSpecification) {
		this.resourceSpecification = newResourceSpecification;
		return this;
	}

	public ResourceCandidateCreateVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ResourceCandidateCreateVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ResourceCandidateCreateVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ResourceCandidateCreateVO atType(java.lang.String newAtType) {
