...
public class ResourceCategoryCreateEventVO {
	...
	private ResourceCategoryCreateEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ResourceCategoryCreateEventVO other = (ResourceCategoryCreateEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCategoryCreateEventVO[")
	...
	public ResourceCategoryCreateEventVO event(ResourceCategoryCreateEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ResourceCategoryCreateEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ResourceCategoryCreateEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ResourceCategoryCreateEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ResourceCategoryCreateEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ResourceCategoryCreateEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ResourceCategoryCreateEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ResourceCategoryCreateEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCategoryCreateEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ResourceCategoryCreateEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ResourceCategoryCreateEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ResourceCategoryCreateEventPayloadVO newEvent) {
		this.event = newEvent;
	}
