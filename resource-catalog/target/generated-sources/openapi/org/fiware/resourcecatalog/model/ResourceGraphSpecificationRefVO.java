...
public class ResourceGraphSpecificationRefVO {
	...
	public boolean equals(Object object) {
		...
		ResourceGraphSpecificationRefVO other = (ResourceGraphSpecificationRefVO) object;
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(id, href, name, atBaseType, atSchemaLocation, atType, atReferredType);
	}

	@Override
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceGraphSpecificationRefVO[")
	...
	public ResourceGraphSpecificationRefVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public ResourceGraphSpecificationRefVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public ResourceGraphSpecificationRefVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ResourceGraphSpecificationRefVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ResourceGraphSpecificationRefVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ResourceGraphSpecificationRefVO atType(java.lang.String newAtType) {
		this.atType = newAtType;
		return this;
	}

	public ResourceGraphSpecificationRefVO atReferredType(java.lang.String newAtReferredType) {
