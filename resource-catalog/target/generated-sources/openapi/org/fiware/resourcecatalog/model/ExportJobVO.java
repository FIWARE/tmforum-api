...
public class ExportJobVO {
	...
	public boolean equals(Object object) {
		...
		ExportJobVO other = (ExportJobVO) object;
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(id, href, completionDate, contentType, creationDate, errorLog, path, query, url, status, atBaseType, atSchemaLocation, atType);
	}
	...
	public ExportJobVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public ExportJobVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public ExportJobVO completionDate(java.time.Instant newCompletionDate) {
		this.completionDate = newCompletionDate;
		return this;
	}

	public ExportJobVO contentType(java.lang.String newContentType) {
		this.contentType = newContentType;
		return this;
	}

	public ExportJobVO creationDate(java.time.Instant newCreationDate) {
		this.creationDate = newCreationDate;
		return this;
	}

	public ExportJobVO errorLog(java.lang.String newErrorLog) {
		this.errorLog = newErrorLog;
		return this;
	}

	public ExportJobVO path(java.lang.String newPath) {
		this.path = newPath;
		return this;
	}

	public ExportJobVO query(java.lang.String newQuery) {
		this.query = newQuery;
		return this;
	}

	public ExportJobVO url(java.net.URI newUrl) {
		this.url = newUrl;
		return this;
	}

	public ExportJobVO status(JobStateTypeVO newStatus) {
		this.status = newStatus;
		return this;
	}

	public ExportJobVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ExportJobVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ExportJobVO atType(java.lang.String newAtType) {
