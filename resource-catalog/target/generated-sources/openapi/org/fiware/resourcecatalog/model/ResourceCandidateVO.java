...
public class ResourceCandidateVO {
	...
	public boolean equals(Object object) {
		...
		ResourceCandidateVO other = (ResourceCandidateVO) object;
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(id, href, description, lastUpdate, lifecycleStatus, name, version, category, resourceSpecification, validFor, atBaseType, atSchemaLocation, atType);
	}

	@Override
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCandidateVO[")
	...
	public ResourceCandidateVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public ResourceCandidateVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public ResourceCandidateVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCandidateVO lastUpdate(java.time.Instant newLastUpdate) {
		this.lastUpdate = newLastUpdate;
		return this;
	}

	public ResourceCandidateVO lifecycleStatus(java.lang.String newLifecycleStatus) {
		this.lifecycleStatus = newLifecycleStatus;
		return this;
	}

	public ResourceCandidateVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ResourceCandidateVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ResourceCandidateVO category(java.util.List<ResourceCategoryRefVO> newCategory) {
		this.category = newCategory;
		return this;
	}
	
	public ResourceCandidateVO addCategoryItem(ResourceCategoryRefVO categoryItem) {
	...
	public ResourceCandidateVO removeCategoryItem(ResourceCategoryRefVO categoryItem) {
		if (this.category != null) {
	...
	public ResourceCandidateVO resourceSpecification(ResourceSpecificationRefVO newResourceSpecification) {
		this.resourceSpecification = newResourceSpecification;
		return this;
	}

	public ResourceCandidateVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ResourceCandidateVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ResourceCandidateVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ResourceCandidateVO atType(java.lang.String newAtType) {
