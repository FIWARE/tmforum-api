...
public class ResourceCatalogUpdateVO {
	...
	public boolean equals(Object object) {
		...
		ResourceCatalogUpdateVO other = (ResourceCatalogUpdateVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCatalogUpdateVO[")
	...
	public ResourceCatalogUpdateVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCatalogUpdateVO lastUpdate(java.time.Instant newLastUpdate) {
		this.lastUpdate = newLastUpdate;
		return this;
	}

	public ResourceCatalogUpdateVO lifecycleStatus(java.lang.String newLifecycleStatus) {
		this.lifecycleStatus = newLifecycleStatus;
		return this;
	}

	public ResourceCatalogUpdateVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ResourceCatalogUpdateVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ResourceCatalogUpdateVO category(java.util.List<ResourceCategoryRefVO> newCategory) {
		this.category = newCategory;
		return this;
	}
	
	public ResourceCatalogUpdateVO addCategoryItem(ResourceCategoryRefVO categoryItem) {
	...
	public ResourceCatalogUpdateVO removeCategoryItem(ResourceCategoryRefVO categoryItem) {
		if (this.category != null) {
	...
	public ResourceCatalogUpdateVO relatedParty(java.util.List<RelatedPartyVO> newRelatedParty) {
		this.relatedParty = newRelatedParty;
		return this;
	}
	
	public ResourceCatalogUpdateVO addRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
	...
	public ResourceCatalogUpdateVO removeRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
		if (this.relatedParty != null) {
	...
	public ResourceCatalogUpdateVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ResourceCatalogUpdateVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ResourceCatalogUpdateVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ResourceCatalogUpdateVO atType(java.lang.String newAtType) {
