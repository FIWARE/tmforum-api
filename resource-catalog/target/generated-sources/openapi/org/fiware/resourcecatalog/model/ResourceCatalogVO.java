...
public class ResourceCatalogVO {
	...
	public boolean equals(Object object) {
		...
		ResourceCatalogVO other = (ResourceCatalogVO) object;
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(id, href, description, lastUpdate, lifecycleStatus, name, version, category, relatedParty, validFor, atBaseType, atSchemaLocation, atType);
	}

	@Override
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCatalogVO[")
	...
	public ResourceCatalogVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public ResourceCatalogVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public ResourceCatalogVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCatalogVO lastUpdate(java.time.Instant newLastUpdate) {
		this.lastUpdate = newLastUpdate;
		return this;
	}

	public ResourceCatalogVO lifecycleStatus(java.lang.String newLifecycleStatus) {
		this.lifecycleStatus = newLifecycleStatus;
		return this;
	}

	public ResourceCatalogVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ResourceCatalogVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ResourceCatalogVO category(java.util.List<ResourceCategoryRefVO> newCategory) {
		this.category = newCategory;
		return this;
	}
	
	public ResourceCatalogVO addCategoryItem(ResourceCategoryRefVO categoryItem) {
	...
	public ResourceCatalogVO removeCategoryItem(ResourceCategoryRefVO categoryItem) {
		if (this.category != null) {
	...
	public ResourceCatalogVO relatedParty(java.util.List<RelatedPartyVO> newRelatedParty) {
		this.relatedParty = newRelatedParty;
		return this;
	}
	
	public ResourceCatalogVO addRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
	...
	public ResourceCatalogVO removeRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
		if (this.relatedParty != null) {
	...
	public ResourceCatalogVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ResourceCatalogVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ResourceCatalogVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ResourceCatalogVO atType(java.lang.String newAtType) {
