...
public class ResourceCandidateRefVO {
	...
	public boolean equals(Object object) {
		...
		ResourceCandidateRefVO other = (ResourceCandidateRefVO) object;
	...
	public ResourceCandidateRefVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public ResourceCandidateRefVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public ResourceCandidateRefVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ResourceCandidateRefVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ResourceCandidateRefVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ResourceCandidateRefVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ResourceCandidateRefVO atType(java.lang.String newAtType) {
		this.atType = newAtType;
		return this;
	}

	public ResourceCandidateRefVO atReferredType(java.lang.String newAtReferredType) {
