...
public class ExportJobCreateEventVO {
	...
	private ExportJobCreateEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ExportJobCreateEventVO other = (ExportJobCreateEventVO) object;
	...
	public ExportJobCreateEventVO event(ExportJobCreateEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ExportJobCreateEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ExportJobCreateEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ExportJobCreateEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ExportJobCreateEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ExportJobCreateEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ExportJobCreateEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ExportJobCreateEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ExportJobCreateEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ExportJobCreateEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ExportJobCreateEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ExportJobCreateEventPayloadVO newEvent) {
		this.event = newEvent;
	}
