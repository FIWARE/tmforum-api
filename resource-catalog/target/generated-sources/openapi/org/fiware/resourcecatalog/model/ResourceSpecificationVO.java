...
public class ResourceSpecificationVO {
	...
	public boolean equals(Object object) {
		...
		ResourceSpecificationVO other = (ResourceSpecificationVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceSpecificationVO[")
	...
	public ResourceSpecificationVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public ResourceSpecificationVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public ResourceSpecificationVO category(java.lang.String newCategory) {
		this.category = newCategory;
		return this;
	}

	public ResourceSpecificationVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceSpecificationVO isBundle(java.lang.Boolean newIsBundle) {
		this.isBundle = newIsBundle;
		return this;
	}

	public ResourceSpecificationVO lastUpdate(java.time.Instant newLastUpdate) {
		this.lastUpdate = newLastUpdate;
		return this;
	}

	public ResourceSpecificationVO lifecycleStatus(java.lang.String newLifecycleStatus) {
		this.lifecycleStatus = newLifecycleStatus;
		return this;
	}

	public ResourceSpecificationVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ResourceSpecificationVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ResourceSpecificationVO attachment(java.util.List<AttachmentRefOrValueVO> newAttachment) {
		this.attachment = newAttachment;
		return this;
	}
	
	public ResourceSpecificationVO addAttachmentItem(AttachmentRefOrValueVO attachmentItem) {
	...
	public ResourceSpecificationVO removeAttachmentItem(AttachmentRefOrValueVO attachmentItem) {
		if (this.attachment != null) {
	...
	public ResourceSpecificationVO featureSpecification(java.util.List<FeatureSpecificationVO> newFeatureSpecification) {
		this.featureSpecification = newFeatureSpecification;
		return this;
	}
	
	public ResourceSpecificationVO addFeatureSpecificationItem(FeatureSpecificationVO featureSpecificationItem) {
	...
	public ResourceSpecificationVO removeFeatureSpecificationItem(FeatureSpecificationVO featureSpecificationItem) {
		if (this.featureSpecification != null) {
	...
	public ResourceSpecificationVO relatedParty(java.util.List<RelatedPartyVO> newRelatedParty) {
		this.relatedParty = newRelatedParty;
		return this;
	}
	
	public ResourceSpecificationVO addRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
	...
	public ResourceSpecificationVO removeRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
		if (this.relatedParty != null) {
	...
	public ResourceSpecificationVO resourceSpecCharacteristic(java.util.List<ResourceSpecificationCharacteristicVO> newResourceSpecCharacteristic) {
		this.resourceSpecCharacteristic = newResourceSpecCharacteristic;
		return this;
	}
	
	public ResourceSpecificationVO addResourceSpecCharacteristicItem(ResourceSpecificationCharacteristicVO resourceSpecCharacteristicItem) {
	...
	public ResourceSpecificationVO removeResourceSpecCharacteristicItem(ResourceSpecificationCharacteristicVO resourceSpecCharacteristicItem) {
		if (this.resourceSpecCharacteristic != null) {
	...
	public ResourceSpecificationVO resourceSpecRelationship(java.util.List<ResourceSpecificationRelationshipVO> newResourceSpecRelationship) {
		this.resourceSpecRelationship = newResourceSpecRelationship;
		return this;
	}
	
	public ResourceSpecificationVO addResourceSpecRelationshipItem(ResourceSpecificationRelationshipVO resourceSpecRelationshipItem) {
	...
	public ResourceSpecificationVO removeResourceSpecRelationshipItem(ResourceSpecificationRelationshipVO resourceSpecRelationshipItem) {
		if (this.resourceSpecRelationship != null) {
	...
	public ResourceSpecificationVO targetResourceSchema(TargetResourceSchemaVO newTargetResourceSchema) {
		this.targetResourceSchema = newTargetResourceSchema;
		return this;
	}

	public ResourceSpecificationVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ResourceSpecificationVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ResourceSpecificationVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ResourceSpecificationVO atType(java.lang.String newAtType) {
