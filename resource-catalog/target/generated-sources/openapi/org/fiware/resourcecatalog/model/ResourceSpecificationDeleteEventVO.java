...
public class ResourceSpecificationDeleteEventVO {
	...
	private ResourceSpecificationDeleteEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ResourceSpecificationDeleteEventVO other = (ResourceSpecificationDeleteEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceSpecificationDeleteEventVO[")
	...
	public ResourceSpecificationDeleteEventVO event(ResourceSpecificationDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ResourceSpecificationDeleteEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ResourceSpecificationDeleteEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ResourceSpecificationDeleteEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ResourceSpecificationDeleteEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ResourceSpecificationDeleteEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ResourceSpecificationDeleteEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ResourceSpecificationDeleteEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceSpecificationDeleteEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ResourceSpecificationDeleteEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ResourceSpecificationDeleteEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ResourceSpecificationDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
	}
