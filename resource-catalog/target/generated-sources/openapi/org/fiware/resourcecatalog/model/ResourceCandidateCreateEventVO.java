...
public class ResourceCandidateCreateEventVO {
	...
	private ResourceCandidateCreateEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ResourceCandidateCreateEventVO other = (ResourceCandidateCreateEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCandidateCreateEventVO[")
	...
	public ResourceCandidateCreateEventVO event(ResourceCandidateCreateEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ResourceCandidateCreateEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ResourceCandidateCreateEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ResourceCandidateCreateEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ResourceCandidateCreateEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ResourceCandidateCreateEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ResourceCandidateCreateEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ResourceCandidateCreateEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCandidateCreateEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ResourceCandidateCreateEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ResourceCandidateCreateEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ResourceCandidateCreateEventPayloadVO newEvent) {
		this.event = newEvent;
	}
