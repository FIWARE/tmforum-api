...
public class ResourceCategoryChangeEventVO {
	...
	private ResourceCategoryChangeEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ResourceCategoryChangeEventVO other = (ResourceCategoryChangeEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCategoryChangeEventVO[")
	...
	public ResourceCategoryChangeEventVO event(ResourceCategoryChangeEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ResourceCategoryChangeEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ResourceCategoryChangeEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ResourceCategoryChangeEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ResourceCategoryChangeEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ResourceCategoryChangeEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ResourceCategoryChangeEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ResourceCategoryChangeEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCategoryChangeEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ResourceCategoryChangeEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ResourceCategoryChangeEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ResourceCategoryChangeEventPayloadVO newEvent) {
		this.event = newEvent;
	}
