...
public class ImportJobStateChangeEventVO {
	...
	private ImportJobStateChangeEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ImportJobStateChangeEventVO other = (ImportJobStateChangeEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ImportJobStateChangeEventVO[")
	...
	public ImportJobStateChangeEventVO event(ImportJobStateChangeEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ImportJobStateChangeEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ImportJobStateChangeEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ImportJobStateChangeEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ImportJobStateChangeEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ImportJobStateChangeEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ImportJobStateChangeEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ImportJobStateChangeEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ImportJobStateChangeEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ImportJobStateChangeEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ImportJobStateChangeEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ImportJobStateChangeEventPayloadVO newEvent) {
		this.event = newEvent;
	}
