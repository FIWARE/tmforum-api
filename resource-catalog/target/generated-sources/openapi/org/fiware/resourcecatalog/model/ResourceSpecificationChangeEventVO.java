...
public class ResourceSpecificationChangeEventVO {
	...
	private ResourceSpecificationChangeEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ResourceSpecificationChangeEventVO other = (ResourceSpecificationChangeEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceSpecificationChangeEventVO[")
	...
	public ResourceSpecificationChangeEventVO event(ResourceSpecificationChangeEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ResourceSpecificationChangeEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ResourceSpecificationChangeEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ResourceSpecificationChangeEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ResourceSpecificationChangeEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ResourceSpecificationChangeEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ResourceSpecificationChangeEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ResourceSpecificationChangeEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceSpecificationChangeEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ResourceSpecificationChangeEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ResourceSpecificationChangeEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ResourceSpecificationChangeEventPayloadVO newEvent) {
		this.event = newEvent;
	}
