...
public class ResourceCategoryUpdateVO {
	...
	public boolean equals(Object object) {
		...
		ResourceCategoryUpdateVO other = (ResourceCategoryUpdateVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCategoryUpdateVO[")
	...
	public ResourceCategoryUpdateVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCategoryUpdateVO isRoot(java.lang.Boolean newIsRoot) {
		this.isRoot = newIsRoot;
		return this;
	}

	public ResourceCategoryUpdateVO lastUpdate(java.time.Instant newLastUpdate) {
		this.lastUpdate = newLastUpdate;
		return this;
	}

	public ResourceCategoryUpdateVO lifecycleStatus(java.lang.String newLifecycleStatus) {
		this.lifecycleStatus = newLifecycleStatus;
		return this;
	}

	public ResourceCategoryUpdateVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ResourceCategoryUpdateVO parentId(java.lang.String newParentId) {
		this.parentId = newParentId;
		return this;
	}

	public ResourceCategoryUpdateVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ResourceCategoryUpdateVO category(java.util.List<ResourceCategoryRefVO> newCategory) {
		this.category = newCategory;
		return this;
	}
	
	public ResourceCategoryUpdateVO addCategoryItem(ResourceCategoryRefVO categoryItem) {
	...
	public ResourceCategoryUpdateVO removeCategoryItem(ResourceCategoryRefVO categoryItem) {
		if (this.category != null) {
	...
	public ResourceCategoryUpdateVO relatedParty(java.util.List<RelatedPartyVO> newRelatedParty) {
		this.relatedParty = newRelatedParty;
		return this;
	}
	
	public ResourceCategoryUpdateVO addRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
	...
	public ResourceCategoryUpdateVO removeRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
		if (this.relatedParty != null) {
	...
	public ResourceCategoryUpdateVO resourceCandidate(java.util.List<ResourceCandidateRefVO> newResourceCandidate) {
		this.resourceCandidate = newResourceCandidate;
		return this;
	}
	
	public ResourceCategoryUpdateVO addResourceCandidateItem(ResourceCandidateRefVO resourceCandidateItem) {
	...
	public ResourceCategoryUpdateVO removeResourceCandidateItem(ResourceCandidateRefVO resourceCandidateItem) {
		if (this.resourceCandidate != null) {
	...
	public ResourceCategoryUpdateVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ResourceCategoryUpdateVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ResourceCategoryUpdateVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ResourceCategoryUpdateVO atType(java.lang.String newAtType) {
