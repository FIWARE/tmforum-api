...
public class ResourceCatalogDeleteEventVO {
	...
	private ResourceCatalogDeleteEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ResourceCatalogDeleteEventVO other = (ResourceCatalogDeleteEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCatalogDeleteEventVO[")
	...
	public ResourceCatalogDeleteEventVO event(ResourceCatalogDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ResourceCatalogDeleteEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ResourceCatalogDeleteEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ResourceCatalogDeleteEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ResourceCatalogDeleteEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ResourceCatalogDeleteEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ResourceCatalogDeleteEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ResourceCatalogDeleteEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCatalogDeleteEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ResourceCatalogDeleteEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ResourceCatalogDeleteEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ResourceCatalogDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
	}
