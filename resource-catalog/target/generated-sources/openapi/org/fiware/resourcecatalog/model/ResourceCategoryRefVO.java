...
public class ResourceCategoryRefVO {
	...
	public boolean equals(Object object) {
		...
		ResourceCategoryRefVO other = (ResourceCategoryRefVO) object;
	...
	public ResourceCategoryRefVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public ResourceCategoryRefVO href(java.net.URI newHref) {
		this.href = newHref;
		return this;
	}

	public ResourceCategoryRefVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ResourceCategoryRefVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ResourceCategoryRefVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ResourceCategoryRefVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ResourceCategoryRefVO atType(java.lang.String newAtType) {
		this.atType = newAtType;
		return this;
	}

	public ResourceCategoryRefVO atReferredType(java.lang.String newAtReferredType) {
