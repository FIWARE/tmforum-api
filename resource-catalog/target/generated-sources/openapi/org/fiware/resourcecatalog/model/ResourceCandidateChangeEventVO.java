...
public class ResourceCandidateChangeEventVO {
	...
	private ResourceCandidateChangeEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ResourceCandidateChangeEventVO other = (ResourceCandidateChangeEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCandidateChangeEventVO[")
	...
	public ResourceCandidateChangeEventVO event(ResourceCandidateChangeEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ResourceCandidateChangeEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ResourceCandidateChangeEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ResourceCandidateChangeEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ResourceCandidateChangeEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ResourceCandidateChangeEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ResourceCandidateChangeEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ResourceCandidateChangeEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCandidateChangeEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ResourceCandidateChangeEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ResourceCandidateChangeEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ResourceCandidateChangeEventPayloadVO newEvent) {
		this.event = newEvent;
	}
