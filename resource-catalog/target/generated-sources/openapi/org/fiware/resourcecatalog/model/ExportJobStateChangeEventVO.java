...
public class ExportJobStateChangeEventVO {
	...
	private ExportJobStateChangeEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ExportJobStateChangeEventVO other = (ExportJobStateChangeEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ExportJobStateChangeEventVO[")
	...
	public ExportJobStateChangeEventVO event(ExportJobStateChangeEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ExportJobStateChangeEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ExportJobStateChangeEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ExportJobStateChangeEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ExportJobStateChangeEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ExportJobStateChangeEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ExportJobStateChangeEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ExportJobStateChangeEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ExportJobStateChangeEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ExportJobStateChangeEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ExportJobStateChangeEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ExportJobStateChangeEventPayloadVO newEvent) {
		this.event = newEvent;
	}
