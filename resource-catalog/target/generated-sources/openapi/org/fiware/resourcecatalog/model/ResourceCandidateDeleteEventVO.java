...
public class ResourceCandidateDeleteEventVO {
	...
	private ResourceCandidateDeleteEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ResourceCandidateDeleteEventVO other = (ResourceCandidateDeleteEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCandidateDeleteEventVO[")
	...
	public ResourceCandidateDeleteEventVO event(ResourceCandidateDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ResourceCandidateDeleteEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ResourceCandidateDeleteEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ResourceCandidateDeleteEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ResourceCandidateDeleteEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ResourceCandidateDeleteEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ResourceCandidateDeleteEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ResourceCandidateDeleteEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCandidateDeleteEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ResourceCandidateDeleteEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ResourceCandidateDeleteEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ResourceCandidateDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
	}
