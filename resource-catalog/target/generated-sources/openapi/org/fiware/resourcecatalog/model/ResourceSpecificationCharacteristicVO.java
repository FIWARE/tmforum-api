...
public class ResourceSpecificationCharacteristicVO {
	...
	public static final java.lang.String JSON_PROPERTY_RESOURCE_SPEC_CHAR_RELATIONSHIP = "resourceSpecCharRelationship";
	public static final java.lang.String JSON_PROPERTY_RESOURCE_SPEC_CHARACTERISTIC_VALUE = "resourceSpecCharacteristicValue";
	...
	@com.fasterxml.jackson.annotation.JsonProperty(JSON_PROPERTY_RESOURCE_SPEC_CHAR_RELATIONSHIP)
	@com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
	private java.util.List<ResourceSpecificationCharacteristicRelationshipVO> resourceSpecCharRelationship;
	...
	@com.fasterxml.jackson.annotation.JsonProperty(JSON_PROPERTY_RESOURCE_SPEC_CHARACTERISTIC_VALUE)
	@com.fasterxml.jackson.annotation.JsonInclude(com.fasterxml.jackson.annotation.JsonInclude.Include.NON_NULL)
	private java.util.List<CharacteristicValueSpecificationVO> resourceSpecCharacteristicValue;
	...
	public boolean equals(Object object) {
		...
		ResourceSpecificationCharacteristicVO other = (ResourceSpecificationCharacteristicVO) object;
		return java.util.Objects.equals(id, other.id)
				...
				&& java.util.Objects.equals(resourceSpecCharRelationship, other.resourceSpecCharRelationship)
				&& java.util.Objects.equals(resourceSpecCharacteristicValue, other.resourceSpecCharacteristicValue)
	...
	@Override
	public int hashCode() {
		return java.util.Objects.hash(id, configurable, description, extensible, isUnique, maxCardinality, minCardinality, name, regex, valueType, resourceSpecCharRelationship, resourceSpecCharacteristicValue, validFor, atBaseType, atSchemaLocation, atType, atValueSchemaLocation);
	}

	@Override
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceSpecificationCharacteristicVO[")
				...
				.append("resourceSpecCharRelationship=").append(resourceSpecCharRelationship).append(",")
				.append("resourceSpecCharacteristicValue=").append(resourceSpecCharacteristicValue).append(",")
	...
	public ResourceSpecificationCharacteristicVO id(java.lang.String newId) {
		this.id = newId;
		return this;
	}

	public ResourceSpecificationCharacteristicVO configurable(java.lang.Boolean newConfigurable) {
		this.configurable = newConfigurable;
		return this;
	}

	public ResourceSpecificationCharacteristicVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceSpecificationCharacteristicVO extensible(java.lang.Boolean newExtensible) {
		this.extensible = newExtensible;
		return this;
	}

	public ResourceSpecificationCharacteristicVO isUnique(java.lang.Boolean newIsUnique) {
		this.isUnique = newIsUnique;
		return this;
	}

	public ResourceSpecificationCharacteristicVO maxCardinality(java.lang.Integer newMaxCardinality) {
		this.maxCardinality = newMaxCardinality;
		return this;
	}

	public ResourceSpecificationCharacteristicVO minCardinality(java.lang.Integer newMinCardinality) {
		this.minCardinality = newMinCardinality;
		return this;
	}

	public ResourceSpecificationCharacteristicVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ResourceSpecificationCharacteristicVO regex(java.lang.String newRegex) {
		this.regex = newRegex;
		return this;
	}

	public ResourceSpecificationCharacteristicVO valueType(java.lang.String newValueType) {
		this.valueType = newValueType;
		return this;
	}

	public ResourceSpecificationCharacteristicVO resourceSpecCharRelationship(java.util.List<ResourceSpecificationCharacteristicRelationshipVO> newResourceSpecCharRelationship) {
		this.resourceSpecCharRelationship = newResourceSpecCharRelationship;
		return this;
	}
	
	public ResourceSpecificationCharacteristicVO addResourceSpecCharRelationshipItem(ResourceSpecificationCharacteristicRelationshipVO resourceSpecCharRelationshipItem) {
		if (this.resourceSpecCharRelationship == null) {
			this.resourceSpecCharRelationship = new java.util.ArrayList<>();
		}
		this.resourceSpecCharRelationship.add(resourceSpecCharRelationshipItem);
		return this;
	}

	public ResourceSpecificationCharacteristicVO removeResourceSpecCharRelationshipItem(ResourceSpecificationCharacteristicRelationshipVO resourceSpecCharRelationshipItem) {
		if (this.resourceSpecCharRelationship != null) {
			this.resourceSpecCharRelationship.remove(resourceSpecCharRelationshipItem);
		}
		return this;
	}

	public ResourceSpecificationCharacteristicVO resourceSpecCharacteristicValue(java.util.List<CharacteristicValueSpecificationVO> newResourceSpecCharacteristicValue) {
		this.resourceSpecCharacteristicValue = newResourceSpecCharacteristicValue;
		return this;
	}
	
	public ResourceSpecificationCharacteristicVO addResourceSpecCharacteristicValueItem(CharacteristicValueSpecificationVO resourceSpecCharacteristicValueItem) {
		if (this.resourceSpecCharacteristicValue == null) {
			this.resourceSpecCharacteristicValue = new java.util.ArrayList<>();
		}
		this.resourceSpecCharacteristicValue.add(resourceSpecCharacteristicValueItem);
		return this;
	}

	public ResourceSpecificationCharacteristicVO removeResourceSpecCharacteristicValueItem(CharacteristicValueSpecificationVO resourceSpecCharacteristicValueItem) {
		if (this.resourceSpecCharacteristicValue != null) {
			this.resourceSpecCharacteristicValue.remove(resourceSpecCharacteristicValueItem);
		}
		return this;
	}

	public ResourceSpecificationCharacteristicVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ResourceSpecificationCharacteristicVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ResourceSpecificationCharacteristicVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ResourceSpecificationCharacteristicVO atType(java.lang.String newAtType) {
		this.atType = newAtType;
		return this;
	}

	public ResourceSpecificationCharacteristicVO atValueSchemaLocation(java.lang.String newAtValueSchemaLocation) {
	...
	public java.util.List<ResourceSpecificationCharacteristicRelationshipVO> getResourceSpecCharRelationship() {
		return resourceSpecCharRelationship;
	}

	public void setResourceSpecCharRelationship(java.util.List<ResourceSpecificationCharacteristicRelationshipVO> newResourceSpecCharRelationship) {
		this.resourceSpecCharRelationship = newResourceSpecCharRelationship;
	}

	public java.util.List<CharacteristicValueSpecificationVO> getResourceSpecCharacteristicValue() {
		return resourceSpecCharacteristicValue;
	}

	public void setResourceSpecCharacteristicValue(java.util.List<CharacteristicValueSpecificationVO> newResourceSpecCharacteristicValue) {
		this.resourceSpecCharacteristicValue = newResourceSpecCharacteristicValue;
	}
