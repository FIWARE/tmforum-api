...
public class ResourceSpecificationCreateVO {
	...
	public boolean equals(Object object) {
		...
		ResourceSpecificationCreateVO other = (ResourceSpecificationCreateVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceSpecificationCreateVO[")
	...
	public ResourceSpecificationCreateVO category(java.lang.String newCategory) {
		this.category = newCategory;
		return this;
	}

	public ResourceSpecificationCreateVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceSpecificationCreateVO isBundle(java.lang.Boolean newIsBundle) {
		this.isBundle = newIsBundle;
		return this;
	}

	public ResourceSpecificationCreateVO lastUpdate(java.time.Instant newLastUpdate) {
		this.lastUpdate = newLastUpdate;
		return this;
	}

	public ResourceSpecificationCreateVO lifecycleStatus(java.lang.String newLifecycleStatus) {
		this.lifecycleStatus = newLifecycleStatus;
		return this;
	}

	public ResourceSpecificationCreateVO name(java.lang.String newName) {
		this.name = newName;
		return this;
	}

	public ResourceSpecificationCreateVO version(java.lang.String newVersion) {
		this.version = newVersion;
		return this;
	}

	public ResourceSpecificationCreateVO attachment(java.util.List<AttachmentRefOrValueVO> newAttachment) {
		this.attachment = newAttachment;
		return this;
	}
	
	public ResourceSpecificationCreateVO addAttachmentItem(AttachmentRefOrValueVO attachmentItem) {
	...
	public ResourceSpecificationCreateVO removeAttachmentItem(AttachmentRefOrValueVO attachmentItem) {
		if (this.attachment != null) {
	...
	public ResourceSpecificationCreateVO featureSpecification(java.util.List<FeatureSpecificationVO> newFeatureSpecification) {
		this.featureSpecification = newFeatureSpecification;
		return this;
	}
	
	public ResourceSpecificationCreateVO addFeatureSpecificationItem(FeatureSpecificationVO featureSpecificationItem) {
	...
	public ResourceSpecificationCreateVO removeFeatureSpecificationItem(FeatureSpecificationVO featureSpecificationItem) {
		if (this.featureSpecification != null) {
	...
	public ResourceSpecificationCreateVO relatedParty(java.util.List<RelatedPartyVO> newRelatedParty) {
		this.relatedParty = newRelatedParty;
		return this;
	}
	
	public ResourceSpecificationCreateVO addRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
	...
	public ResourceSpecificationCreateVO removeRelatedPartyItem(RelatedPartyVO relatedPartyItem) {
		if (this.relatedParty != null) {
	...
	public ResourceSpecificationCreateVO resourceSpecCharacteristic(java.util.List<ResourceSpecificationCharacteristicVO> newResourceSpecCharacteristic) {
		this.resourceSpecCharacteristic = newResourceSpecCharacteristic;
		return this;
	}
	
	public ResourceSpecificationCreateVO addResourceSpecCharacteristicItem(ResourceSpecificationCharacteristicVO resourceSpecCharacteristicItem) {
	...
	public ResourceSpecificationCreateVO removeResourceSpecCharacteristicItem(ResourceSpecificationCharacteristicVO resourceSpecCharacteristicItem) {
		if (this.resourceSpecCharacteristic != null) {
	...
	public ResourceSpecificationCreateVO resourceSpecRelationship(java.util.List<ResourceSpecificationRelationshipVO> newResourceSpecRelationship) {
		this.resourceSpecRelationship = newResourceSpecRelationship;
		return this;
	}
	
	public ResourceSpecificationCreateVO addResourceSpecRelationshipItem(ResourceSpecificationRelationshipVO resourceSpecRelationshipItem) {
	...
	public ResourceSpecificationCreateVO removeResourceSpecRelationshipItem(ResourceSpecificationRelationshipVO resourceSpecRelationshipItem) {
		if (this.resourceSpecRelationship != null) {
	...
	public ResourceSpecificationCreateVO targetResourceSchema(TargetResourceSchemaVO newTargetResourceSchema) {
		this.targetResourceSchema = newTargetResourceSchema;
		return this;
	}

	public ResourceSpecificationCreateVO validFor(TimePeriodVO newValidFor) {
		this.validFor = newValidFor;
		return this;
	}

	public ResourceSpecificationCreateVO atBaseType(java.lang.String newAtBaseType) {
		this.atBaseType = newAtBaseType;
		return this;
	}

	public ResourceSpecificationCreateVO atSchemaLocation(java.net.URI newAtSchemaLocation) {
		this.atSchemaLocation = newAtSchemaLocation;
		return this;
	}

	public ResourceSpecificationCreateVO atType(java.lang.String newAtType) {
