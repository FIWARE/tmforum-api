...
public class ResourceCategoryDeleteEventVO {
	...
	private ResourceCategoryDeleteEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ResourceCategoryDeleteEventVO other = (ResourceCategoryDeleteEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCategoryDeleteEventVO[")
	...
	public ResourceCategoryDeleteEventVO event(ResourceCategoryDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ResourceCategoryDeleteEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ResourceCategoryDeleteEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ResourceCategoryDeleteEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ResourceCategoryDeleteEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ResourceCategoryDeleteEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ResourceCategoryDeleteEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ResourceCategoryDeleteEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCategoryDeleteEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ResourceCategoryDeleteEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ResourceCategoryDeleteEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ResourceCategoryDeleteEventPayloadVO newEvent) {
		this.event = newEvent;
	}
