...
public class ResourceCatalogCreateEventVO {
	...
	private ResourceCatalogCreateEventPayloadVO event;
	...
	public boolean equals(Object object) {
		...
		ResourceCatalogCreateEventVO other = (ResourceCatalogCreateEventVO) object;
	...
	public java.lang.String toString() {
		return new java.lang.StringBuilder()
				.append("ResourceCatalogCreateEventVO[")
	...
	public ResourceCatalogCreateEventVO event(ResourceCatalogCreateEventPayloadVO newEvent) {
		this.event = newEvent;
		return this;
	}

	public ResourceCatalogCreateEventVO eventId(java.lang.String newEventId) {
		this.eventId = newEventId;
		return this;
	}

	public ResourceCatalogCreateEventVO eventTime(java.time.Instant newEventTime) {
		this.eventTime = newEventTime;
		return this;
	}

	public ResourceCatalogCreateEventVO eventType(java.lang.String newEventType) {
		this.eventType = newEventType;
		return this;
	}

	public ResourceCatalogCreateEventVO correlationId(java.lang.String newCorrelationId) {
		this.correlationId = newCorrelationId;
		return this;
	}

	public ResourceCatalogCreateEventVO domain(java.lang.String newDomain) {
		this.domain = newDomain;
		return this;
	}

	public ResourceCatalogCreateEventVO title(java.lang.String newTitle) {
		this.title = newTitle;
		return this;
	}

	public ResourceCatalogCreateEventVO description(java.lang.String newDescription) {
		this.description = newDescription;
		return this;
	}

	public ResourceCatalogCreateEventVO priority(java.lang.String newPriority) {
		this.priority = newPriority;
		return this;
	}

	public ResourceCatalogCreateEventVO timeOcurred(java.time.Instant newTimeOcurred) {
	...
	public ResourceCatalogCreateEventPayloadVO getEvent() {
		return event;
	}

	public void setEvent(ResourceCatalogCreateEventPayloadVO newEvent) {
		this.event = newEvent;
	}
