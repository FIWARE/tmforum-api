...
import org.fiware.resourceordering.api.EventsSubscriptionApi;
import org.fiware.resourceordering.model.EventSubscriptionInputVO;
import org.fiware.resourceordering.model.EventSubscriptionVO;
...
import static org.fiware.tmforum.common.notification.EventConstants.EVENT_GROUP_CANCEL_RESOURCE_ORDER;
import static org.fiware.tmforum.common.notification.EventConstants.EVENT_GROUP_RESOURCE_ORDER;

/**
 * Controller handling event subscription endpoints for the Resource Order Management API.
 */
@Slf4j
...
public class EventSubscriptionApiController extends AbstractSubscriptionApiController implements EventsSubscriptionApi {
	...
	private static final Map<String, String> EVENT_GROUP_TO_ENTITY_NAME_MAPPING = Map.ofEntries(
			entry(EVENT_GROUP_CANCEL_RESOURCE_ORDER, CancelResourceOrder.TYPE_CANCEL_RESOURCE_ORDER),
			entry(EVENT_GROUP_RESOURCE_ORDER, ResourceOrder.TYPE_RESOURCE_ORDER)
	);
	private static final List<String> EVENT_GROUPS = List.of(
			EVENT_GROUP_CANCEL_RESOURCE_ORDER, EVENT_GROUP_RESOURCE_ORDER);
