...
@Produces
@Singleton
@Requires(classes = {PartyUpdateException.class, ExceptionHandler.class})
@Slf4j
public class PartyUpdateExceptionHandler implements ExceptionHandler<PartyUpdateException, HttpResponse<ErrorDetails>> {

    @Override
    public HttpResponse<ErrorDetails> handle(HttpRequest request, PartyUpdateException exception) {
