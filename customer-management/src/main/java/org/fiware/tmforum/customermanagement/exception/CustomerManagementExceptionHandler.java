...
@Produces
@Singleton
@Requires(classes = {CustomerManagementException.class, ExceptionHandler.class})
@Slf4j
public class CustomerManagementExceptionHandler implements ExceptionHandler<CustomerManagementException, HttpResponse<ErrorDetails>> {

    @Override
    public HttpResponse<ErrorDetails> handle(HttpRequest request, CustomerManagementException exception) {
