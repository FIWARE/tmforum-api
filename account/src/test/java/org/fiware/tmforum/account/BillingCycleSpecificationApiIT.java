...
import org.fiware.account.model.BillingCycleSpecificationUpdateVOTestExample;
import org.fiware.account.model.BillingCycleSpecificationVO;
import org.fiware.account.model.BillingCycleSpecificationVOTestExample;
import org.fiware.account.model.TimePeriodVO;
import org.fiware.account.model.TimePeriodVOTestExample;
...
public class BillingCycleSpecificationApiIT extends AbstractApiIT implements BillingCycleSpecificationApiTestSpec {
	...
	public void deleteBillingCycleSpecification204() throws Exception {
		...
		assertEquals(HttpStatus.NO_CONTENT,
				callAndCatch(() -> billingCycleSpecificationApiTestClient.deleteBillingCycleSpecification(null, billingCycleSpecificationId)).getStatus(),
				"The billingCycleSpecification should have been deleted.");

		assertEquals(HttpStatus.NOT_FOUND,
				callAndCatch(() -> billingCycleSpecificationApiTestClient.retrieveBillingCycleSpecification(null, billingCycleSpecificationId, null)).status(),
	...
	public void deleteBillingCycleSpecification404() throws Exception {
		HttpResponse<?> notFoundResponse = callAndCatch(
				() -> billingCycleSpecificationApiTestClient.deleteBillingCycleSpecification(null, "urn:ngsi-ld:billingCycleSpecification:no-billingCycleSpecification"));
		assertEquals(HttpStatus.NOT_FOUND,
		...
		notFoundResponse = callAndCatch(() -> billingCycleSpecificationApiTestClient.deleteBillingCycleSpecification(null, "invalid-id"));
		assertEquals(HttpStatus.NOT_FOUND,
				notFoundResponse.getStatus(),
				"No such billingCycleSpecification should exist.");
	...
	public void listBillingCycleSpecification200() throws Exception {
		...
		HttpResponse<List<BillingCycleSpecificationVO>> billingCycleSpecificationResponse = callAndCatch(
				() -> billingCycleSpecificationApiTestClient.listBillingCycleSpecification(null, null, null, null));
		...
		HttpResponse<List<BillingCycleSpecificationVO>> firstPartResponse = callAndCatch(
				() -> billingCycleSpecificationApiTestClient.listBillingCycleSpecification(null, null, 0, limit));
		assertEquals(limit, firstPartResponse.body().size(),
				"Only the requested number of entries should be returend.");
		HttpResponse<List<BillingCycleSpecificationVO>> secondPartResponse = callAndCatch(
				() -> billingCycleSpecificationApiTestClient.listBillingCycleSpecification(null, null, 0 + limit, limit));
	...
	public void listBillingCycleSpecification400() throws Exception {
		HttpResponse<List<BillingCycleSpecificationVO>> badRequestResponse = callAndCatch(
				() -> billingCycleSpecificationApiTestClient.listBillingCycleSpecification(null, null, -1, null));
		...
		badRequestResponse = callAndCatch(() -> billingCycleSpecificationApiTestClient.listBillingCycleSpecification(null, null, null, -1));
		assertEquals(HttpStatus.BAD_REQUEST,
				badRequestResponse.getStatus(),
	...
	public void patchBillingCycleSpecification200() throws Exception {
		...
		HttpResponse<BillingCycleSpecificationVO> updateResponse = callAndCatch(
				() -> billingCycleSpecificationApiTestClient.patchBillingCycleSpecification(null, billingCycleSpecificationId, billingCycleSpecificationUpdateVO));
	...
	private static Stream<Arguments> provideBillingCycleSpecificationUpdates() {
		...
		BillingCycleSpecificationVO expectedNewBillingDateShift = BillingCycleSpecificationVOTestExample.build().atSchemaLocation(null).validFor(null);
		...
		BillingCycleSpecificationVO expectedNewBillingPeriod = BillingCycleSpecificationVOTestExample.build().atSchemaLocation(null).validFor(null);
		...
		BillingCycleSpecificationVO expectedChargeDateOffset = BillingCycleSpecificationVOTestExample.build().atSchemaLocation(null).validFor(null);
		...
		BillingCycleSpecificationVO expectedCreditDateOffset = BillingCycleSpecificationVOTestExample.build().atSchemaLocation(null).validFor(null);
		...
		BillingCycleSpecificationVO expectedNewDesc = BillingCycleSpecificationVOTestExample.build().atSchemaLocation(null).validFor(null);
		...
		BillingCycleSpecificationVO expectedNewFrequency = BillingCycleSpecificationVOTestExample.build().atSchemaLocation(null).validFor(null);
		...
		BillingCycleSpecificationVO expectedMailingDateOffset = BillingCycleSpecificationVOTestExample.build().atSchemaLocation(null).validFor(null);
		...
		BillingCycleSpecificationVO expectedNewName = BillingCycleSpecificationVOTestExample.build().atSchemaLocation(null).validFor(null);
		...
		BillingCycleSpecificationVO expectedPaymentDateOffset = BillingCycleSpecificationVOTestExample.build().atSchemaLocation(null).validFor(null);
	...
	public void retrieveBillingCycleSpecification200() throws Exception {
		...
		expectedBillingCycleSpecification.validFor(null);

		//then retrieve
		HttpResponse<BillingCycleSpecificationVO> retrievedBillingCycleSpecification = callAndCatch(() -> billingCycleSpecificationApiTestClient.retrieveBillingCycleSpecification(null, id, null));
	...
	public void retrieveBillingCycleSpecification404() throws Exception {
		HttpResponse<BillingCycleSpecificationVO> response = callAndCatch(
				() -> billingCycleSpecificationApiTestClient.retrieveBillingCycleSpecification(null, "urn:ngsi-ld:billingCycleSpecification:non-existent", null));
