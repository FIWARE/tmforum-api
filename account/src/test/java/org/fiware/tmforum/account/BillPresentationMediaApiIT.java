...
public class BillPresentationMediaApiIT extends AbstractApiIT implements BillPresentationMediaApiTestSpec {
	...
	public void deleteBillPresentationMedia204() throws Exception {
		...
		assertEquals(HttpStatus.NO_CONTENT,
				callAndCatch(() -> billPresentationMediaApiTestClient.deleteBillPresentationMedia(null, billPresentationMediaId)).getStatus(),
				"The billPresentationMedia should have been deleted.");

		assertEquals(HttpStatus.NOT_FOUND,
				callAndCatch(() -> billPresentationMediaApiTestClient.retrieveBillPresentationMedia(null, billPresentationMediaId, null)).status(),
	...
	public void deleteBillPresentationMedia404() throws Exception {
		HttpResponse<?> notFoundResponse = callAndCatch(
				() -> billPresentationMediaApiTestClient.deleteBillPresentationMedia(null, "urn:ngsi-ld:billPresentationMedia:no-billPresentationMedia"));
		assertEquals(HttpStatus.NOT_FOUND,
		...
		notFoundResponse = callAndCatch(() -> billPresentationMediaApiTestClient.deleteBillPresentationMedia(null, "invalid-id"));
		assertEquals(HttpStatus.NOT_FOUND,
				notFoundResponse.getStatus(),
				"No such billPresentationMedia should exist.");
	...
	public void listBillPresentationMedia200() throws Exception {
		...
		HttpResponse<List<BillPresentationMediaVO>> billPresentationMediaResponse = callAndCatch(
				() -> billPresentationMediaApiTestClient.listBillPresentationMedia(null, null, null, null));
		...
		HttpResponse<List<BillPresentationMediaVO>> firstPartResponse = callAndCatch(
				() -> billPresentationMediaApiTestClient.listBillPresentationMedia(null, null, 0, limit));
		assertEquals(limit, firstPartResponse.body().size(),
				"Only the requested number of entries should be returend.");
		HttpResponse<List<BillPresentationMediaVO>> secondPartResponse = callAndCatch(
				() -> billPresentationMediaApiTestClient.listBillPresentationMedia(null, null, 0 + limit, limit));
	...
	public void listBillPresentationMedia400() throws Exception {
		HttpResponse<List<BillPresentationMediaVO>> badRequestResponse = callAndCatch(
				() -> billPresentationMediaApiTestClient.listBillPresentationMedia(null, null, -1, null));
		...
		badRequestResponse = callAndCatch(() -> billPresentationMediaApiTestClient.listBillPresentationMedia(null, null, null, -1));
		assertEquals(HttpStatus.BAD_REQUEST,
				badRequestResponse.getStatus(),
	...
	public void patchBillPresentationMedia200() throws Exception {
		...
		HttpResponse<BillPresentationMediaVO> updateResponse = callAndCatch(
				() -> billPresentationMediaApiTestClient.patchBillPresentationMedia(null, billPresentationMediaId, billPresentationMediaUpdateVO));
	...
	public void retrieveBillPresentationMedia200() throws Exception {
		...
		//then retrieve
		HttpResponse<BillPresentationMediaVO> retrievedBillPresentationMedia = callAndCatch(() -> billPresentationMediaApiTestClient.retrieveBillPresentationMedia(null, id, null));
	...
	public void retrieveBillPresentationMedia404() throws Exception {
		HttpResponse<BillPresentationMediaVO> response = callAndCatch(
				() -> billPresentationMediaApiTestClient.retrieveBillPresentationMedia(null, "urn:ngsi-ld:billPresentationMedia:non-existent", null));
