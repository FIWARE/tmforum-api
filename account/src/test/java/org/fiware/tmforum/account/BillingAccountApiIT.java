...
public class BillingAccountApiIT extends AbstractApiIT implements BillingAccountApiTestSpec {
    ...
    public void createBillingAccount201() throws Exception {
        ...
        HttpResponse<BillingAccountVO> billingAccountVOHttpResponse = callAndCatch(
                () -> billingAccountApiTestClient.createBillingAccount(billingAccountCreateVO));
    ...
    public void deleteBillingAccount204() throws Exception {
        ...
        assertEquals(HttpStatus.NO_CONTENT,
                callAndCatch(() -> billingAccountApiTestClient.deleteBillingAccount(billingAccountId)).getStatus(),
                "The billingAccount should have been deleted.");

        assertEquals(HttpStatus.NOT_FOUND,
                callAndCatch(() -> billingAccountApiTestClient.retrieveBillingAccount(billingAccountId, null)).status(),
    ...
    public void deleteBillingAccount404() throws Exception {
        HttpResponse<?> notFoundResponse = callAndCatch(
                () -> billingAccountApiTestClient.deleteBillingAccount("urn:ngsi-ld:billingAccount:no-billingAccount"));
        assertEquals(HttpStatus.NOT_FOUND,
        ...
        notFoundResponse = callAndCatch(() -> billingAccountApiTestClient.deleteBillingAccount("invalid-id"));
        assertEquals(HttpStatus.NOT_FOUND,
                notFoundResponse.getStatus(),
                "No such billingAccount should exist.");
    ...
    public void listBillingAccount200() throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            BillingAccountCreateVO billingAccountCreateVO = BillingAccountCreateVOTestExample.build()
                    ...
                    .financialAccount(null);
            fixExampleCreate(billingAccountCreateVO);
            String id = billingAccountApiTestClient.createBillingAccount(billingAccountCreateVO).body().getId();
        ...
        HttpResponse<List<BillingAccountVO>> billingAccountResponse = callAndCatch(
                () -> billingAccountApiTestClient.listBillingAccount(null, null, null));
        ...
        HttpResponse<List<BillingAccountVO>> firstPartResponse = callAndCatch(
                () -> billingAccountApiTestClient.listBillingAccount(null, 0, limit));
        assertEquals(limit, firstPartResponse.body().size(),
                "Only the requested number of entries should be returend.");
        HttpResponse<List<BillingAccountVO>> secondPartResponse = callAndCatch(
                () -> billingAccountApiTestClient.listBillingAccount(null, 0 + limit, limit));
    ...
    public void listBillingAccount400() throws Exception {
        HttpResponse<List<BillingAccountVO>> badRequestResponse = callAndCatch(
                () -> billingAccountApiTestClient.listBillingAccount(null, -1, null));
        ...
        badRequestResponse = callAndCatch(() -> billingAccountApiTestClient.listBillingAccount(null, null, -1));
        assertEquals(HttpStatus.BAD_REQUEST,
                badRequestResponse.getStatus(),
    ...
    public void patchBillingAccount200() throws Exception {
        ...
        HttpResponse<BillingAccountVO> updateResponse = callAndCatch(
                () -> billingAccountApiTestClient.patchBillingAccount(billingAccountId, billingAccountUpdateVO));
        ...
        expectedBillingAccount.setHref(billingAccountId);
        expectedBillingAccount.setId(billingAccountId);
        expectedBillingAccount.setRelatedParty(null);
        expectedBillingAccount.setFinancialAccount(null);
        expectedBillingAccount.setDefaultPaymentMethod(null);
    ...
    public void patchBillingAccount404() throws Exception {
        ...
        assertEquals(
                ...
                callAndCatch(() -> billingAccountApiTestClient.patchBillingAccount("urn:ngsi-ld:billingAccount:not-existent",
    ...
    public void retrieveBillingAccount200() throws Exception {
        ...
        //then retrieve
        HttpResponse<BillingAccountVO> retrievedBillingAccount = callAndCatch(() -> billingAccountApiTestClient.retrieveBillingAccount(id, null));
    ...
    public void retrieveBillingAccount404() throws Exception {
        HttpResponse<BillingAccountVO> response = callAndCatch(
                () -> billingAccountApiTestClient.retrieveBillingAccount("urn:ngsi-ld:billingAccount:non-existent", null));
