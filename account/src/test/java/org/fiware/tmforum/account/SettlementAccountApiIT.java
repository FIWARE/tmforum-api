...
import org.fiware.account.model.BillFormatRefOrValueVO;
import org.fiware.account.model.BillFormatRefOrValueVOTestExample;
import org.fiware.account.model.BillStructureVO;
import org.fiware.account.model.BillStructureVOTestExample;
import org.fiware.account.model.BillingCycleSpecificationRefOrValueVO;
import org.fiware.account.model.BillingCycleSpecificationRefOrValueVOTestExample;
...
import org.fiware.account.model.SettlementAccountCreateVOTestExample;
import org.fiware.account.model.SettlementAccountUpdateVO;
import org.fiware.account.model.SettlementAccountUpdateVOTestExample;
import org.fiware.account.model.SettlementAccountVO;
import org.fiware.account.model.SettlementAccountVOTestExample;
...
public class SettlementAccountApiIT extends AbstractApiIT implements SettlementAccountApiTestSpec {
	...
	private static Stream<Arguments> provideValidSettlementAccounts() {
		...
		SettlementAccountCreateVO settlementAccountCreateVO = SettlementAccountCreateVOTestExample.build().atSchemaLocation(null).defaultPaymentMethod(null).financialAccount(null);
		SettlementAccountVO expectedSettlementAccount = SettlementAccountVOTestExample.build().atSchemaLocation(null).defaultPaymentMethod(null).financialAccount(null);
	...
	private static Stream<Arguments> provideInvalidSettlementAccounts() {
		...
		SettlementAccountCreateVO invalidRelatedPartyCreate = SettlementAccountCreateVOTestExample.build().atSchemaLocation(null)
		...
		SettlementAccountCreateVO nonExistentRelatedPartyCreate = SettlementAccountCreateVOTestExample.build().atSchemaLocation(null)
				.defaultPaymentMethod(null)
				.financialAccount(null);
		// no existent id
		...
		SettlementAccountCreateVO nonExistentDefaultPaymentMethodCreate = SettlementAccountCreateVOTestExample.build().atSchemaLocation(null)
				.financialAccount(null);
		// no existent id
		...
		SettlementAccountCreateVO nonExistentFinancialAccountCreate = SettlementAccountCreateVOTestExample.build().atSchemaLocation(null)
				.defaultPaymentMethod(null);
		// no existent id
	...
	public void deleteSettlementAccount204() throws Exception {
		//first create
		SettlementAccountCreateVO settlementAccountCreateVO = SettlementAccountCreateVOTestExample.build().atSchemaLocation(null)
				.defaultPaymentMethod(null)
				.financialAccount(null);
	...
	public void listSettlementAccount200() throws Exception {
		...
		for (int i = 0; i < 10; i++) {
			...
			SettlementAccountVO settlementAccountVO = SettlementAccountVOTestExample.build().atSchemaLocation(null);
	...
	private static Stream<Arguments> provideSettlementAccountUpdates() {
		...
		SettlementAccountUpdateVO newTypeSettlementAccount = SettlementAccountUpdateVOTestExample.build().atSchemaLocation(null)
				.financialAccount(null)
				.defaultPaymentMethod(null);
		fixExampleUpdate(newTypeSettlementAccount);
		newTypeSettlementAccount.setAccountType("New-Type");
		SettlementAccountVO expectedNewType = SettlementAccountVOTestExample.build().atSchemaLocation(null)
				.relatedParty(null);
		...
		SettlementAccountUpdateVO newDesc = SettlementAccountUpdateVOTestExample.build().atSchemaLocation(null)
				.financialAccount(null)
				.defaultPaymentMethod(null);
		fixExampleUpdate(newDesc);
		newDesc.setDescription("New description");
		SettlementAccountVO expectedNewDesc = SettlementAccountVOTestExample.build().atSchemaLocation(null)
				.relatedParty(null);
		...
		SettlementAccountUpdateVO newName = SettlementAccountUpdateVOTestExample.build().atSchemaLocation(null)
				.financialAccount(null)
				.defaultPaymentMethod(null);
		fixExampleUpdate(newName);
		newName.setName("New name");
		SettlementAccountVO expectedNewName = SettlementAccountVOTestExample.build().atSchemaLocation(null)
				.relatedParty(null);
	...
	private static Stream<Arguments> provideInvalidUpdates() {
		...
		SettlementAccountUpdateVO invalidRelatedPartyUpdate = SettlementAccountUpdateVOTestExample.build().atSchemaLocation(null)
				.financialAccount(null)
				.defaultPaymentMethod(null);
		...
		SettlementAccountUpdateVO nonExistentRelatedPartyUpdate = SettlementAccountUpdateVOTestExample.build().atSchemaLocation(null)
				.financialAccount(null)
				.defaultPaymentMethod(null);
		...
		SettlementAccountUpdateVO nonExistentFinancialAccountUpdate = SettlementAccountUpdateVOTestExample.build().atSchemaLocation(null)
				.defaultPaymentMethod(null);
		...
		SettlementAccountUpdateVO nonExistentDefaultPaymentMethodUpdate = SettlementAccountUpdateVOTestExample.build().atSchemaLocation(null)
				.financialAccount(null);
	...
	public void patchSettlementAccount404() throws Exception {
		SettlementAccountUpdateVO settlementAccountUpdateVO = SettlementAccountUpdateVOTestExample.build().atSchemaLocation(null).billStructure(null).financialAccount(null).defaultPaymentMethod(null);
		assertEquals(
	...
	public void retrieveSettlementAccount200() throws Exception {
		...
		SettlementAccountVO expectedSettlementAccount = SettlementAccountVOTestExample.build().atSchemaLocation(null)
				.relatedParty(null);
