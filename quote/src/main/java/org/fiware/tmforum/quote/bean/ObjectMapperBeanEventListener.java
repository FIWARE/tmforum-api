package org.fiware.tmforum.quote.bean;
...
public class ObjectMapperBeanEventListener implements BeanCreatedEventListener<ObjectMapper> {
    ...
    public ObjectMapper onCreated(BeanCreatedEvent<ObjectMapper> event) {
        log.debug("Add FieldCleaningSerializer to Quote VOs");
        ...
        fieldParamModule.addSerializer(QuoteVO.class, new FieldCleaningSerializer<>());
