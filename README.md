...
- Unit-Tests, using [JUnit5](https://junit.org/junit5/docs/current/user-guide/) to test on a function-level. See [mapping-tests](mapping/src/test/java) as an example
