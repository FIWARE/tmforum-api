...
@MappingEnabled(entityType = ServiceCandidate.TYPE_SERVICE_CANDIDATE)
public class ServiceCandidate extends EntityWithId {

    public static final String TYPE_SERVICE_CANDIDATE = "service-candidate";
