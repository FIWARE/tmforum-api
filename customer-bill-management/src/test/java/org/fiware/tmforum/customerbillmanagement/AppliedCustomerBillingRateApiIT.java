...
public class AppliedCustomerBillingRateApiIT extends AbstractApiIT implements
	...
	public void deleteAppliedCustomerBill204() throws Exception {
		...
		assertEquals(HttpStatus.NO_CONTENT,
				callAndCatch(() -> appliedCustomerBillingRateApiTestClient.deleteAppliedCustomerBill(null, billId)).getStatus(),
	...
	public void deleteAppliedCustomerBill404() throws Exception {
		HttpResponse<?> notFoundResponse = callAndCatch(
				() -> appliedCustomerBillingRateApiTestClient.deleteAppliedCustomerBill(null, "urn:ngsi-ld:customer-bill:no-bill"));
		assertEquals(HttpStatus.NOT_FOUND,
		...
		notFoundResponse = callAndCatch(() -> appliedCustomerBillingRateApiTestClient.deleteAppliedCustomerBill(null, "invalid-id"));
		assertEquals(HttpStatus.NOT_FOUND,
				notFoundResponse.getStatus(),
