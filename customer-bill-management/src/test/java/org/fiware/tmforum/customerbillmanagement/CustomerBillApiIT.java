...
public class CustomerBillApiIT extends AbstractApiIT implements CustomerBillApiTestSpec {
	...
	public void listCustomerBill200() throws Exception {
		...
		HttpResponse<List<CustomerBillVO>> customerBillResponse = callAndCatch(
				() -> customerBillApiTestClient.listCustomerBill(null, null, null, null));
		...
		HttpResponse<List<CustomerBillVO>> firstPartResponse = callAndCatch(
				() -> customerBillApiTestClient.listCustomerBill(null, null, 0, limit));
		assertEquals(limit, firstPartResponse.body().size(),
				"Only the requested number of entries should be returend.");
		HttpResponse<List<CustomerBillVO>> secondPartResponse = callAndCatch(
				() -> customerBillApiTestClient.listCustomerBill(null, null, 0 + limit, limit));
	...
	public void listCustomerBill400() throws Exception {
		HttpResponse<List<CustomerBillVO>> badRequestResponse = callAndCatch(
				() -> customerBillApiTestClient.listCustomerBill(null, null, -1, null));
		...
		badRequestResponse = callAndCatch(() -> customerBillApiTestClient.listCustomerBill(null, null, null, -1));
		assertEquals(HttpStatus.BAD_REQUEST,
				badRequestResponse.getStatus(),
	...
	@Override
	public void listCustomerBill500() throws Exception {
	}
	...
	@Test
	@Override
	public void patchCustomerBill405() throws Exception {
	...
	@Test
	@Override
	public void patchCustomerBill409() throws Exception {

	}

	@Override
	public void patchCustomerBill500() throws Exception {
	...
	public void retrieveCustomerBill200() throws Exception {
		...
		HttpResponse<CustomerBillVO> response = callAndCatch(
				() -> customerBillApiTestClient.retrieveCustomerBill(null, billId, fieldsParameter));
	...
	@Test
	@Override
	public void retrieveCustomerBill404() throws Exception {
		HttpResponse<CustomerBillVO> response = callAndCatch(
				() -> customerBillApiTestClient.retrieveCustomerBill(null, "urn:ngsi-ld:customer-bill:non-existent",
						fieldsParameter));
	...
	@Override
	public void retrieveCustomerBill500() throws Exception {
	...
	public void deleteCustomerBill404() throws Exception {
		HttpResponse<?> notFoundResponse = callAndCatch(
				() -> customerBillApiTestClient.deleteCustomerBill(null, "urn:ngsi-ld:customer-bill:no-bill"));
		assertEquals(HttpStatus.NOT_FOUND,
