...
public class UsageApiIT extends AbstractApiIT implements UsageApiTestSpec {
	...
	private static Stream<Arguments> provideValidUsages() {
		...
		UsageCreateVO usageCreateVO = UsageCreateVOTestExample.build().atSchemaLocation(null).usageSpecification(null);
		UsageVO expectedUsage = UsageVOTestExample.build().atSchemaLocation(null).usageSpecification(null);
		testEntries.add(
	...
	private static Stream<Arguments> provideInvalidUsages() {
		...
		UsageCreateVO invalidRelatedPartyCreate = UsageCreateVOTestExample.build().atSchemaLocation(null);
		// no valid id
		...
		UsageCreateVO nonExistentRelatedPartyCreate = UsageCreateVOTestExample.build().atSchemaLocation(null);
		// no existent id
		...
		UsageCreateVO invalidUsageCharacteristicCreate = UsageCreateVOTestExample.build().atSchemaLocation(null);
		// no valid id
		UsageCharacteristicVO usageCharacteristic = UsageCharacteristicVOTestExample.build().atSchemaLocation(null);
		...
		UsageCreateVO nonExistentUsageCharacteristicCreate = UsageCreateVOTestExample.build().atSchemaLocation(null);
		// no existent id
		UsageCharacteristicVO nonExistentUsageCharacteristic = UsageCharacteristicVOTestExample.build().atSchemaLocation(null);
	...
	private static Stream<Arguments> provideInvalidUpdates() {
		...
		UsageUpdateVO invalidRelatedPartyUpdate = UsageUpdateVOTestExample.build().atSchemaLocation(null);
		// no valid id
		RelatedPartyVO invalidRelatedParty = RelatedPartyVOTestExample.build().atSchemaLocation(null);
		...
		UsageUpdateVO nonExistentRelatedPartyUpdate = UsageUpdateVOTestExample.build().atSchemaLocation(null);
		// no existent id
		RelatedPartyVO nonExistentRelatedParty = RelatedPartyVOTestExample.build().atSchemaLocation(null);
		nonExistentRelatedParty.setId("urn:ngsi-ld:usage:non-existent");
		...
		UsageUpdateVO invalidUsageCharacteristicUpdate = UsageUpdateVOTestExample.build().atSchemaLocation(null);
		// no valid id
		UsageCharacteristicVO usageCharacteristic = UsageCharacteristicVOTestExample.build().atSchemaLocation(null);
		...
		UsageUpdateVO nonExistentUsageCharacteristicUpdate = UsageUpdateVOTestExample.build().atSchemaLocation(null);
		// no existent id
		UsageCharacteristicVO nonExistentUsageCharacteristic = UsageCharacteristicVOTestExample.build().atSchemaLocation(null);
		nonExistentUsageCharacteristic.setId("urn:ngsi-ld:usage:non-existent");
